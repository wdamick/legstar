 ...
 * the specific Java byte to cobol octet stream representation.
 *
 * @author Fady Moussallam
 * 
 */
public interface ICobolOctetStreamConverter {
    /**
     ...
     */
    int toHost(ICobolOctetStreamBinding ce, byte[] hostTarget, int offset)
     ...
     * @throws HostException if conversion fails
     */
    int toHost(ICobolArrayOctetStreamBinding ce, byte[] hostTarget, int offset,
            int currentOccurs)
    throws HostException;
     ...
     */
    int fromHost(
            ICobolOctetStreamBinding ce, byte[] hostSource, int offset)
    throws HostException;
     ...
     */
    int fromHost(
            ICobolArrayOctetStreamBinding ce, byte[] hostSource, int offset,
            int currentOccurs)
    throws HostException;
}
