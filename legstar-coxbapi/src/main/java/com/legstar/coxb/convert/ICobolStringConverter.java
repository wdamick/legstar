 ...
 * the specific Java String to cobol representation.
 *
 * @author Fady Moussallam
 * 
 */
public interface ICobolStringConverter {
    /**
     ...
     */
    int toHost(ICobolStringBinding ce, byte[] hostTarget, int offset)
     ...
     * @throws HostException if conversion fails
     */
    int toHost(ICobolArrayStringBinding ce, byte[] hostTarget, int offset,
            int currentOccurs)
    throws HostException;
     ...
     * @throws HostException if conversion fails
     */
    int fromHost(ICobolStringBinding ce, byte[] hostSource, int offset)
    throws HostException;
     ...
     * @throws HostException if conversion fails
     */
    int fromHost(ICobolArrayStringBinding ce, byte[] hostSource, int offset,
            int currentOccurs)
    throws HostException;
}
