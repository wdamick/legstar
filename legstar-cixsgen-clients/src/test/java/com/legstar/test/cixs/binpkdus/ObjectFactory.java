...
public class ObjectFactory {
    ...
    private final static QName _HostHeader_QNAME = new QName("http://cixs.test.legstar.com/binpkdus", "HostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/binpkdus", name = "HostHeader")
    public JAXBElement<BinpkdusHostHeader> createHostHeader(BinpkdusHostHeader value) {
        return new JAXBElement<BinpkdusHostHeader>(_HostHeader_QNAME, BinpkdusHostHeader.class, null, value);
    }
