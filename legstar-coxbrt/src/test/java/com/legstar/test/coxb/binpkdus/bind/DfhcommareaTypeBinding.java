...
public class DfhcommareaTypeBinding 
    ...
    /** Child property LsUnsignedPackedDecimalTypeBinding of complex type. */
    public LsUnsignedPackedDecimalTypeBinding lsUnsignedPackedDecimal;
    ...
    public final void initChildren() {
        ...
        lsUnsignedPackedDecimal = new LsUnsignedPackedDecimalTypeBinding(this);
        
        /* Add children to children list */
           
        getChildrenList().add(lsUnsignedPackedDecimal);
    }
    ...
    public final void prepareChildren() throws HostException {
        ...
        /* Pass on the JAXB factory to child lsUnsignedPackedDecimal  */
        lsUnsignedPackedDecimal.setObjectFactory(mObjectFactory);
    ...
    public final void getValuesFromBoundObject() throws HostException {
        ...
        if (mJaxbObject.getLsUnsignedPackedDecimal() != null) {
            /* Set value from lsUnsignedPackedDecimal*/
            lsUnsignedPackedDecimal.setJaxbObject(mJaxbObject.getLsUnsignedPackedDecimal());
            
        } else {
            lsUnsignedPackedDecimal.setJaxbObject(mObjectFactory.createLsUnsignedPackedDecimalType());
        }
    ...
    public final void setBoundObjectValue(final int index) throws HostException {
        ...
        switch (index) {
        case 0:
            setBoundObjectValueLsUnsignedPackedDecimal();
            break;
        }
    }
            
    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueLsUnsignedPackedDecimal() throws HostException {
    
        /* Set value of complex child lsUnsignedPackedDecimal*/
        mJaxbObject.setLsUnsignedPackedDecimal(lsUnsignedPackedDecimal.getJaxbObject());
