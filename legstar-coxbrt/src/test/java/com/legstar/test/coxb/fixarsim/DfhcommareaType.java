...
public class DfhcommareaType {
    ...
    @CobolElement(cobolName = "C-ARRAY", type = CobolType.ALPHANUMERIC_ITEM, byteLength = 5, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, minOccurs = 3, maxOccurs = 3)
