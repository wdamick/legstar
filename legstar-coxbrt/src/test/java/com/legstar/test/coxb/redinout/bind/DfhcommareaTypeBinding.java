...
public class DfhcommareaTypeBinding 
    ...
    /** Child property CBufferChoiceBinding of choice type. */
    public CBufferChoiceBinding cBuffer;
    ...
    public final void initChildren() {
        ...
        cBuffer = new CBufferChoiceBinding(this);
        
        /* Add children to children list */
           
        getChildrenList().add(cNumeric);
        getChildrenList().add(cBuffer);
    }
    ...
    public final void prepareChildren() throws HostException {
        ...
        /* Child cBuffer is a choice. Because JAXB does not create
         * objects for choices, we propagate the parent object. */
        cBuffer.setJaxbObject(mJaxbObject);
        cBuffer.setObjectFactory(mObjectFactory);
