...
public class LsFullwordsType {
    ...
    @CobolElement(cobolName = "LS-PS9X9-LOW", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected int lsPs9X9Low;
    @XmlElement(name = "LsPs9X9High")
    @CobolElement(cobolName = "LS-PS9X9-HIGH", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
