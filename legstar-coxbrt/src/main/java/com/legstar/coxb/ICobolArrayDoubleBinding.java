 ...
 * 
*/
public interface ICobolArrayDoubleBinding extends ICobolBinding {
	
	/**
	 * @return Returns an ArrayList of Doubles 
	 * @throws HostException list cannot be created
	 */
	List < Double > getValue() throws HostException;
	 ...
	 */
	void setValue(List < Double > iArray) throws HostException;
