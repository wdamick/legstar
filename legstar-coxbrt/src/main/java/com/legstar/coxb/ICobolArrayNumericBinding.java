...
/**
 * This interface groups methods that are common to all cobol numeric array
 * elements.
 * 
 * @author Fady Moussallam
 * 
*/
public interface ICobolArrayNumericBinding extends ICobolBinding {
	
	/**
	 * @return Returns an ArrayList of BigDecimals 
	 * @throws HostException list cannot be returned
	 */
	List < BigDecimal > getValue() throws HostException;
	 ...
	 */
	void setValue(List < BigDecimal > iArray) throws HostException;
