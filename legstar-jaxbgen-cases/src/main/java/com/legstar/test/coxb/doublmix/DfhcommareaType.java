...
public class DfhcommareaType {
    ...
    @CobolElement(cobolName = "C-DOUBLE-1234", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 21)
    protected double cDouble1234;
    @XmlElement(name = "CDouble0")
    @CobolElement(cobolName = "C-DOUBLE-0", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 22)
    protected double cDouble0;
    @XmlElement(name = "CDouble1")
    @CobolElement(cobolName = "C-DOUBLE-1", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 23)
    protected double cDouble1;
    @XmlElement(name = "CDouble345006P5678")
    @CobolElement(cobolName = "C-DOUBLE-345006p5678", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 24)
    protected double cDouble345006P5678;
    @XmlElement(name = "CDouble798P20067Em16")
    @CobolElement(cobolName = "C-DOUBLE-798p20067em16", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 25)
    protected double cDouble798P20067Em16;
    @XmlElement(name = "CDouble3P40282347Ep38")
    @CobolElement(cobolName = "C-DOUBLE-3p40282347ep38", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 26)
