...
public class WsTransactionDescriptionType {
    ...
    @CobolElement(cobolName = "WS-TRANSACTION-START", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 68)
    protected String wsTransactionStart;
    @XmlElement(name = "WsTransactionName", required = true)
    @CobolElement(cobolName = "WS-TRANSACTION-NAME", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 69)
    protected String wsTransactionName;
    @XmlElement(name = "WsTransactionProgram", required = true)
    @CobolElement(cobolName = "WS-TRANSACTION-PROGRAM", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 70)
    protected String wsTransactionProgram;
    @XmlElement(name = "WsTransactionStatus")
    @CobolElement(cobolName = "WS-TRANSACTION-STATUS", type = CobolType.BINARY_ITEM, levelNumber = 5, byteLength = 4, isSigned = false, totalDigits = 8, picture = "9(8)", usage = "BINARY", srceLine = 71)
