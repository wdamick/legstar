...
public class WsDoublewordsType {
    ...
    @CobolElement(cobolName = "WS-P9X18-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = false, totalDigits = 18, picture = "9(18)", usage = "COMP-5", srceLine = 42)
    protected BigInteger wsP9X18Min;
    @XmlElement(name = "WsP9X18Low", required = true)
    @CobolElement(cobolName = "WS-P9X18-LOW", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = false, totalDigits = 18, picture = "9(18)", usage = "COMP-5", srceLine = 43)
    ...
    @CobolElement(cobolName = "WS-P9X18-HIGH", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = false, totalDigits = 18, redefines = "WS-P9X18-HIGH-B", picture = "9(18)", usage = "COMP-5", srceLine = 48)
    ...
    @CobolElement(cobolName = "WS-P9X18-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = false, totalDigits = 18, redefines = "WS-P9X18-MAX-B", picture = "9(18)", usage = "COMP-5", srceLine = 53)
