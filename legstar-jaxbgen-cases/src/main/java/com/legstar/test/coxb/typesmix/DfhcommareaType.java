...
public class DfhcommareaType {
    ...
    @CobolElement(cobolName = "C-ALPHABETIC", type = CobolType.ALPHABETIC_ITEM, levelNumber = 5, byteLength = 5, picture = "A(5)", usage = "DISPLAY", srceLine = 21)
    protected String cAlphabetic;
    @XmlElement(name = "CNational", required = true)
    @CobolElement(cobolName = "C-NATIONAL", type = CobolType.NATIONAL_ITEM, levelNumber = 5, byteLength = 18, picture = "N(9)", usage = "NATIONAL", srceLine = 22)
    protected String cNational;
    @XmlElement(name = "CDbcs", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @CobolElement(cobolName = "C-DBCS", type = CobolType.DBCS_ITEM, levelNumber = 5, byteLength = 8, picture = "G(4)", usage = "DISPLAY-1", srceLine = 23)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] cDbcs;
    @XmlElement(name = "CAlphanumericEdited", required = true)
    @CobolElement(cobolName = "C-ALPHANUMERIC-EDITED", type = CobolType.ALPHANUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 14, picture = "A(2)X(3)/9900BBB/", usage = "DISPLAY", srceLine = 24)
    protected String cAlphanumericEdited;
    @XmlElement(name = "CAlphanumeric", required = true)
    @CobolElement(cobolName = "C-ALPHANUMERIC", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 7, picture = "X(7)", usage = "DISPLAY", srceLine = 25)
    protected String cAlphanumeric;
    @XmlElement(name = "COctetString", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @CobolElement(cobolName = "C-OCTET-STRING", type = CobolType.OCTET_STREAM_ITEM, levelNumber = 5, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 26)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] cOctetString;
    @XmlElement(name = "CSingleFloat")
    @CobolElement(cobolName = "C-SINGLE-FLOAT", type = CobolType.SINGLE_FLOAT_ITEM, levelNumber = 5, byteLength = 4, usage = "COMP-1", srceLine = 27)
    protected float cSingleFloat;
    @XmlElement(name = "CDoubleFloat")
    @CobolElement(cobolName = "C-DOUBLE-FLOAT", type = CobolType.DOUBLE_FLOAT_ITEM, levelNumber = 5, byteLength = 8, usage = "COMP-2", srceLine = 28)
    protected double cDoubleFloat;
    @XmlElement(name = "CPackedDecimal", required = true)
    @CobolElement(cobolName = "C-PACKED-DECIMAL", type = CobolType.PACKED_DECIMAL_ITEM, levelNumber = 5, byteLength = 9, isSigned = true, totalDigits = 17, fractionDigits = 2, picture = "S9(15)V99", usage = "PACKED-DECIMAL", srceLine = 29)
    protected BigDecimal cPackedDecimal;
    @XmlElement(name = "CZonedDecimal")
    @CobolElement(cobolName = "C-ZONED-DECIMAL", type = CobolType.ZONED_DECIMAL_ITEM, levelNumber = 5, byteLength = 14, isSigned = true, totalDigits = 14, picture = "S9(5)9(9)", usage = "DISPLAY", srceLine = 30)
    protected long cZonedDecimal;
    @XmlElement(name = "CNumericEdited1", required = true)
    @CobolElement(cobolName = "C-NUMERIC-EDITED-1", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 8, isSigned = true, totalDigits = 6, fractionDigits = 6, picture = "PPP009999CR", usage = "DISPLAY", srceLine = 31)
    protected String cNumericEdited1;
    @XmlElement(name = "CNumericEdited2", required = true)
    @CobolElement(cobolName = "C-NUMERIC-EDITED-2", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 16, isSigned = true, totalDigits = 11, fractionDigits = 3, picture = "$$$9999/,99.999+", usage = "DISPLAY", srceLine = 32)
    protected String cNumericEdited2;
    @XmlElement(name = "CNumericEdited3", required = true)
    @CobolElement(cobolName = "C-NUMERIC-EDITED-3", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 10, isSigned = false, totalDigits = 9, fractionDigits = 2, picture = "****999.99", usage = "DISPLAY", srceLine = 33)
    protected String cNumericEdited3;
    @XmlElement(name = "CNumericEdited4", required = true)
    @CobolElement(cobolName = "C-NUMERIC-EDITED-4", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 11, isSigned = true, totalDigits = 9, fractionDigits = 3, picture = "-ZZZZ99.999", usage = "DISPLAY", srceLine = 34)
    protected String cNumericEdited4;
    @XmlElement(name = "CIndex", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @CobolElement(cobolName = "C-INDEX", type = CobolType.INDEX_ITEM, levelNumber = 5, byteLength = 4, usage = "INDEX", srceLine = 35)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] cIndex;
    @XmlElement(name = "CPointer", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @CobolElement(cobolName = "C-POINTER", type = CobolType.POINTER_ITEM, levelNumber = 5, byteLength = 4, usage = "POINTER", srceLine = 36)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] cPointer;
    @XmlElement(name = "CProcPointer", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @CobolElement(cobolName = "C-PROC-POINTER", type = CobolType.PROC_POINTER_ITEM, levelNumber = 5, byteLength = 8, usage = "PROCEDURE-POINTER", srceLine = 37)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] cProcPointer;
    @XmlElement(name = "CFuncPointer", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @CobolElement(cobolName = "C-FUNC-POINTER", type = CobolType.FUNC_POINTER_ITEM, levelNumber = 5, byteLength = 4, usage = "FUNCTION-POINTER", srceLine = 38)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] cFuncPointer;
    @XmlElement(name = "CExternalFloating", required = true)
    @CobolElement(cobolName = "C-EXTERNAL-FLOATING", type = CobolType.EXTERNAL_FLOATING_ITEM, levelNumber = 5, byteLength = 10, isSigned = true, totalDigits = 4, fractionDigits = 2, picture = "+99.99E-99", usage = "DISPLAY", srceLine = 39)
    protected String cExternalFloating;
    @XmlElement(name = "CBinary")
    @CobolElement(cobolName = "C-BINARY", type = CobolType.BINARY_ITEM, levelNumber = 5, byteLength = 4, isSigned = true, totalDigits = 9, picture = "S9(9)", usage = "BINARY", srceLine = 40)
    protected int cBinary;
    @XmlElement(name = "CNativeBinary")
    @CobolElement(cobolName = "C-NATIVE-BINARY", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 5, byteLength = 2, isSigned = false, totalDigits = 4, picture = "9(4)", usage = "COMP-5", srceLine = 41)
