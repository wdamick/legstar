...
public class ReplyStatusType {
    ...
    @CobolElement(cobolName = "REPLY-TYPE", type = CobolType.BINARY_ITEM, levelNumber = 5, byteLength = 2, isSigned = false, totalDigits = 4, picture = "9(4)", usage = "BINARY", srceLine = 77)
    protected int replyType;
    @XmlElement(name = "SearchDuration", required = true)
    @CobolElement(cobolName = "SEARCH-DURATION", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 80)
    protected String searchDuration;
    @XmlElement(name = "TotalItemsRead")
    @CobolElement(cobolName = "TOTAL-ITEMS-READ", type = CobolType.PACKED_DECIMAL_ITEM, levelNumber = 5, byteLength = 5, isSigned = false, totalDigits = 8, picture = "9(8)", usage = "PACKED-DECIMAL", srceLine = 81)
    protected long totalItemsRead;
    @XmlElement(name = "ReplyResp")
    @CobolElement(cobolName = "REPLY-RESP", type = CobolType.BINARY_ITEM, levelNumber = 5, byteLength = 4, isSigned = true, totalDigits = 8, picture = "S9(8)", usage = "BINARY", srceLine = 82)
    protected int replyResp;
    @XmlElement(name = "ReplyResp2")
    @CobolElement(cobolName = "REPLY-RESP2", type = CobolType.BINARY_ITEM, levelNumber = 5, byteLength = 4, isSigned = true, totalDigits = 8, picture = "S9(8)", usage = "BINARY", srceLine = 83)
    protected int replyResp2;
    @XmlElement(name = "ReplyMessage", required = true)
    @CobolElement(cobolName = "REPLY-MESSAGE", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 128, picture = "X(128)", usage = "DISPLAY", srceLine = 84)
