...
public class LsUnsignedNativeType {
    ...
    @CobolElement(cobolName = "LS-P9X4-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 2, isSigned = false, totalDigits = 4, picture = "9(4)", usage = "COMP-5", srceLine = 42)
    protected int lsP9X4Min;
    @XmlElement(name = "LsP9X4Max")
    @CobolElement(cobolName = "LS-P9X4-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 2, isSigned = false, totalDigits = 4, picture = "9(4)", usage = "COMP-5", srceLine = 43)
    protected int lsP9X4Max;
    @XmlElement(name = "LsP9X9Min")
    @CobolElement(cobolName = "LS-P9X9-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 4, isSigned = false, totalDigits = 9, picture = "9(9)", usage = "COMP-5", srceLine = 44)
    protected long lsP9X9Min;
    @XmlElement(name = "LsP9X9Max")
    @CobolElement(cobolName = "LS-P9X9-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 4, isSigned = false, totalDigits = 9, picture = "9(9)", usage = "COMP-5", srceLine = 45)
    protected long lsP9X9Max;
    @XmlElement(name = "LsP9X18Min", required = true)
    @CobolElement(cobolName = "LS-P9X18-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 8, isSigned = false, totalDigits = 18, picture = "9(18)", usage = "COMP-5", srceLine = 46)
    protected BigInteger lsP9X18Min;
    @XmlElement(name = "LsP9X18Max", required = true)
    @CobolElement(cobolName = "LS-P9X18-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 8, isSigned = false, totalDigits = 18, picture = "9(18)", usage = "COMP-5", srceLine = 47)
