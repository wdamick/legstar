...
public class DfhcommareaType {
    ...
    @CobolElement(cobolName = "COM-NUMBER", type = CobolType.ZONED_DECIMAL_ITEM, levelNumber = 5, byteLength = 6, isSigned = false, totalDigits = 6, picture = "9(6)", usage = "DISPLAY", srceLine = 33)
    protected long comNumber;
    @XmlElement(name = "ComName", required = true)
    @CobolElement(cobolName = "COM-NAME", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 20, picture = "X(20)", usage = "DISPLAY", srceLine = 34)
    protected String comName;
    @XmlElement(name = "ComAddress", required = true)
    @CobolElement(cobolName = "COM-ADDRESS", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 20, picture = "X(20)", usage = "DISPLAY", srceLine = 35)
    protected String comAddress;
    @XmlElement(name = "ComPhone", required = true)
    @CobolElement(cobolName = "COM-PHONE", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 36)
