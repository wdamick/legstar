...
public class ReplyPersonalType {
    ...
    @CobolElement(cobolName = "REPLY-NAME", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 20, byteLength = 20, picture = "X(20)", usage = "DISPLAY", srceLine = 71)
    protected String replyName;
    @XmlElement(name = "ReplyAddress", required = true)
    @CobolElement(cobolName = "REPLY-ADDRESS", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 20, byteLength = 20, picture = "X(20)", usage = "DISPLAY", srceLine = 72)
    protected String replyAddress;
    @XmlElement(name = "ReplyPhone", required = true)
    @CobolElement(cobolName = "REPLY-PHONE", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 20, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 73)
