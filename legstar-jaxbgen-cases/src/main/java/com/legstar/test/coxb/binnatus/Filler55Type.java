...
public class Filler55Type {
    ...
    @CobolElement(cobolName = "WS-PS9X4-DIS-1", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 6, isSigned = true, totalDigits = 5, picture = "+9(5)", usage = "DISPLAY", srceLine = 56)
    protected String wsPs9X4Dis1;
    @XmlElement(name = "WsPs9X9Dis1", required = true)
    @CobolElement(cobolName = "WS-PS9X9-DIS-1", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 11, isSigned = true, totalDigits = 10, picture = "+9(10)", usage = "DISPLAY", srceLine = 57)
    protected String wsPs9X9Dis1;
    @XmlElement(name = "WsPs9X18Dis1", required = true)
    @CobolElement(cobolName = "WS-PS9X18-DIS-1", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 21, isSigned = true, totalDigits = 20, picture = "+9(20)", usage = "DISPLAY", srceLine = 58)
    protected String wsPs9X18Dis1;
    @XmlElement(name = "WsPs9X4Dis2", required = true)
    @CobolElement(cobolName = "WS-PS9X4-DIS-2", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 6, isSigned = true, totalDigits = 5, picture = "+9(5)", usage = "DISPLAY", srceLine = 59)
    protected String wsPs9X4Dis2;
    @XmlElement(name = "WsPs9X9Dis2", required = true)
    @CobolElement(cobolName = "WS-PS9X9-DIS-2", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 11, isSigned = true, totalDigits = 10, picture = "+9(10)", usage = "DISPLAY", srceLine = 60)
    protected String wsPs9X9Dis2;
    @XmlElement(name = "WsPs9X18Dis2", required = true)
    @CobolElement(cobolName = "WS-PS9X18-DIS-2", type = CobolType.NUMERIC_EDITED_ITEM, levelNumber = 5, byteLength = 21, isSigned = true, totalDigits = 20, picture = "+9(20)", usage = "DISPLAY", srceLine = 61)
