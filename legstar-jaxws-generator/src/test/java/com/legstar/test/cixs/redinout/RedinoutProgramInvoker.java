...
import com.legstar.test.coxb.redinout.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program REDINOUT.
 * <p/>
 * This host program maps to operation redinout.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class RedinoutProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for redinout. */
    private static final String  OPERATION_NAME = "redinout";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public RedinoutProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new RedinoutHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the REDINOUT host program.
     * <p/>
