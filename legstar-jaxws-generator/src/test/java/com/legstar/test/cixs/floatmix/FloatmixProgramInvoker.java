...
import com.legstar.test.coxb.floatmix.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program FLOATMIX.
 * <p/>
 * This host program maps to operation floatmix.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class FloatmixProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for floatmix. */
    private static final String  OPERATION_NAME = "floatmix";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public FloatmixProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new FloatmixHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the FLOATMIX host program.
     * <p/>
