...
/**
 * Implements an invoker for program DPLARCHT.
 * <p/>
 * This host program maps to operation dplarcht.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class DplarchtProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for dplarcht. */
    private static final String  OPERATION_NAME = "dplarcht";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public DplarchtProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new DplarchtHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the DPLARCHT host program.
     * <p/>
