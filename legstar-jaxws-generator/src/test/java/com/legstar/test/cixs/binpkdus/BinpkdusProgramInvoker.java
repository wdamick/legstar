...
import com.legstar.test.coxb.binpkdus.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program BINPKDUS.
 * <p/>
 * This host program maps to operation binpkdus.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class BinpkdusProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for binpkdus. */
    private static final String  OPERATION_NAME = "binpkdus";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public BinpkdusProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new BinpkdusHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the BINPKDUS host program.
     * <p/>
