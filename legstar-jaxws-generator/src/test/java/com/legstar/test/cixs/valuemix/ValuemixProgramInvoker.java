...
import com.legstar.test.coxb.valuemix.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program VALUEMIX.
 * <p/>
 * This host program maps to operation valuemix.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class ValuemixProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for valuemix. */
    private static final String  OPERATION_NAME = "valuemix";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public ValuemixProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new ValuemixHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the VALUEMIX host program.
     * <p/>
