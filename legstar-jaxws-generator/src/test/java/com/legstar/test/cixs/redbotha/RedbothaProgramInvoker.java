...
import com.legstar.test.coxb.redbotha.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program REDBOTHA.
 * <p/>
 * This host program maps to operation redbotha.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class RedbothaProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for redbotha. */
    private static final String  OPERATION_NAME = "redbotha";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public RedbothaProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new RedbothaHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the REDBOTHA host program.
     * <p/>
