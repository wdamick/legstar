...
import com.legstar.test.coxb.arrayssm.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program ARRAYSSM.
 * <p/>
 * This host program maps to operation arrayssm.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class ArrayssmProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for arrayssm. */
    private static final String  OPERATION_NAME = "arrayssm";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public ArrayssmProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new ArrayssmHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the ARRAYSSM host program.
     * <p/>
