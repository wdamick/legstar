...
import com.legstar.test.coxb.vararcom.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program VARARCOM.
 * <p/>
 * This host program maps to operation vararcom.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class VararcomProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for vararcom. */
    private static final String  OPERATION_NAME = "vararcom";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public VararcomProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new VararcomHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the VARARCOM host program.
     * <p/>
