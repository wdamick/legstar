...
public class ClientbinnatusTest extends TestCase {
    ...
    public void testClient() throws BinnatusFault {
        ...
        assertEquals(32769, dfhcommareaResp.getLsUnsignedNative()
                .getLsHalfwords().getLsP9X4High());
        assertEquals(127, dfhcommareaResp.getLsUnsignedNative()
                .getLsHalfwords().getLsP9X4Low());
        assertEquals(65535, dfhcommareaResp.getLsUnsignedNative()
                .getLsHalfwords().getLsP9X4Max());
        assertEquals(0, dfhcommareaResp.getLsUnsignedNative().getLsHalfwords()
                .getLsP9X4Min());

        assertEquals(2147483649l, dfhcommareaResp.getLsUnsignedNative()
                .getLsFullwords().getLsP9X9High());
        assertEquals(65534, dfhcommareaResp.getLsUnsignedNative()
                .getLsFullwords().getLsP9X9Low());
        assertEquals(4294967295l, dfhcommareaResp.getLsUnsignedNative()
                .getLsFullwords().getLsP9X9Max());
        assertEquals(0, dfhcommareaResp.getLsUnsignedNative().getLsFullwords()
                .getLsP9X9Min());

        assertEquals(new BigInteger("18446744069414584318"), dfhcommareaResp
                .getLsUnsignedNative().getLsDoublewords().getLsP9X18High());
        assertEquals(new BigInteger("4294967294"), dfhcommareaResp
                .getLsUnsignedNative().getLsDoublewords().getLsP9X18Low());
        assertEquals(new BigInteger("18446744073709551615"), dfhcommareaResp
                .getLsUnsignedNative().getLsDoublewords().getLsP9X18Max());
        assertEquals(new BigInteger("0"), dfhcommareaResp.getLsUnsignedNative()
                .getLsDoublewords().getLsP9X18Min());
    }
