...
/**
 * Transforms a ReplyData data object to mainframe data.
 * <p/>
 ...
 *
 */
public class ReplyDataJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public ReplyDataJavaToHostTransformer() {
        super();
    }
     ...
     */
    public ReplyDataJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public ReplyDataJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
