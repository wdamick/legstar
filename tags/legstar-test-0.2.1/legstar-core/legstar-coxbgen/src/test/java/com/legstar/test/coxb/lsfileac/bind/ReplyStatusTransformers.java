...
/**
 * Transformer provider for ReplyStatus java data object.
 *
 */
public class ReplyStatusTransformers extends AbstractTransformers {
    ...
    public ReplyStatusTransformers() {
        super(new ReplyStatusJavaToHostTransformer(),
                new ReplyStatusHostToJavaTransformer());
    }
     ...
     */
    public ReplyStatus toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public ReplyStatus toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public ReplyStatus toJava(final byte[] hostData, final int offset,
