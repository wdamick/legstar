...
import com.legstar.test.coxb.binarcht.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program BINARCHT.
 * <p/>
 * This host program maps to operation binarcht.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class BinarchtProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for binarcht. */
    private static final String  OPERATION_NAME = "binarcht";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public BinarchtProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new BinarchtHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the BINARCHT host program.
     * <p/>
