...
/**
 * Implements an invoker for program ARRAYGRP.
 * <p/>
 * This host program maps to operation arraygrp.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class ArraygrpProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for arraygrp. */
    private static final String  OPERATION_NAME = "arraygrp";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public ArraygrpProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new ArraygrpHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the ARRAYGRP host program.
     * <p/>
