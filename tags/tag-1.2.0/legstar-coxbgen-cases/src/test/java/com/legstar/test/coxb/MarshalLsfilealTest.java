...
public class MarshalLsfilealTest extends TestCase {
	...
	public void testLsfileal() throws Exception {
		...
		ReplyDataType replyData = (ReplyDataType) Util.getJaxbObject(SCHEMA_NAME, "ReplyDataType");
		...
		Filler65Type replyFiller65 = new Filler65Type();
		
		ReplyItemType replyItem1 = new ReplyItemType();
		ReplyPersonalType replyPersonal1 = new ReplyPersonalType();
		...
		ReplyItemType replyItem2 = new ReplyItemType();
		ReplyPersonalType replyPersonal2 = new ReplyPersonalType();
		...
		assertEquals("",
				Util.marshal(SCHEMA_NAME, "ReplyDataType", replyData, 301));
	}
	...
	public void testLsfilealError() throws Exception {
		...
		ReplyErrorHeaderType replyErrorHeader = new ReplyErrorHeaderType();
		...
		assertEquals("",
				Util.marshal(SCHEMA_NAME, "ReplyDataType", replyData, 143));
	}
}
