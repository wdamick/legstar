...
/**
 * Transformer provider for RequestParms java data object.
 *
 */
public class RequestParmsTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public RequestParmsTransformers() {
        super(new RequestParmsJavaToHostTransformer(),
                new RequestParmsHostToJavaTransformer());
    }
     ...
     */
    public RequestParms toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public RequestParms toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public RequestParms toJava(final byte[] hostData, final int offset,
