...
/**
 * Transformer provider for JVMQueryRequest java data object.
 *
 */
public class JvmQueryRequestTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public JvmQueryRequestTransformers() {
        super(new JvmQueryRequestJavaToHostTransformer(),
                new JvmQueryRequestHostToJavaTransformer());
    }
     ...
     */
    public JVMQueryRequest toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public JVMQueryRequest toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public JVMQueryRequest toJava(final byte[] hostData, final int offset,
