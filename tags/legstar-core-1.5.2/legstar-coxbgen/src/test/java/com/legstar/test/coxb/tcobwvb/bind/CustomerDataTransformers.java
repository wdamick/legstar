...
public class CustomerDataTransformers extends AbstractTransformers {
    ...
    public CustomerDataTransformers() {
        super(new CustomerDataJavaToHostTransformer(),
                new CustomerDataHostToJavaTransformer());
    }
     ...
     */
    public CustomerData toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public CustomerData toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public CustomerData toJava(final byte[] hostData, final int offset,
