...
/**
 * Transforms a QueryJvmResponse data object to mainframe data.
 * <p/>
 ...
 *
 */
public class QueryJvmResponseJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public QueryJvmResponseJavaToHostTransformer() {
        super();
    }
     ...
     */
    public QueryJvmResponseJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public QueryJvmResponseJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
