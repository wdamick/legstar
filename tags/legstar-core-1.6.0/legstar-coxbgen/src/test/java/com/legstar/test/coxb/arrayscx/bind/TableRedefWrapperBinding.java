...
public class TableRedefWrapperBinding 
     ...
     */
    public TableRedefWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, TableRedef.class, null, parentBinding, complexItemBinding);
        setMinOccurs(3);
        setMaxOccurs(3);
    }
    ...
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < TableRedef >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((TableRedef) getComplexItemBinding().
            getObjectValue(TableRedef.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < TableRedef >) list;
    }
    
    /** {@inheritDoc} */
    public Object getObjectValue(
            final Class < ? > type) throws HostException {
        if (type.equals(TableRedef.class)) {
            return mValueObject;
        } else {
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(TableRedef.class)) {
                mValueObject = (List < TableRedef >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < TableRedef > getTableRedef() throws HostException {
        return (List < TableRedef >) getObjectValue(TableRedef.class);
    }
