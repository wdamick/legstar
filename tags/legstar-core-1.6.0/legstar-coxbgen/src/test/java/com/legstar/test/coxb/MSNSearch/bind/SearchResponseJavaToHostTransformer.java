...
/**
 * Transforms a SearchResponse data object to mainframe data.
 * <p/>
 ...
 *
 */
public class SearchResponseJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public SearchResponseJavaToHostTransformer() {
        super();
    }
     ...
     */
    public SearchResponseJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public SearchResponseJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
