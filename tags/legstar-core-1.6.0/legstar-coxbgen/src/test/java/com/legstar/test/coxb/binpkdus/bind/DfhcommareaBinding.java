...
public class DfhcommareaBinding 
    ...
    /** Child bound to value object property LsUnsignedPackedDecimal(LsUnsignedPackedDecimal). */
    public ICobolComplexBinding _lsUnsignedPackedDecimal;
    ...
    */
    ...
    private void initChildren() {
        ...
        _lsUnsignedPackedDecimal = new LsUnsignedPackedDecimalBinding("LsUnsignedPackedDecimal",
               "LsUnsignedPackedDecimal", this, null);
        _lsUnsignedPackedDecimal.setCobolName("LS-UNSIGNED-PACKED-DECIMAL");
        _lsUnsignedPackedDecimal.setByteLength(44);

        /* Add children to children list */
        getChildrenList().add(_lsUnsignedPackedDecimal);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _lsUnsignedPackedDecimal */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_lsUnsignedPackedDecimal"
                    + " value=" + mValueObject.getLsUnsignedPackedDecimal());
        }
        _lsUnsignedPackedDecimal.setObjectValue(mValueObject.getLsUnsignedPackedDecimal());
     }
