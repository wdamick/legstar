...
public class DfhcommareaBinding 
    ...
    /** Child bound to value object property ListOdo(String). */
    public ICobolArrayStringBinding _listOdo;
    ...
    */
    ...
    private void initChildren() {
        ...
        _listOdoCounter = BF.createBinaryBinding("ListOdoCounter",
               this);
        _listOdoCounter.setCobolName("LIST-ODO--C");
        _listOdoCounter.setByteLength(4);
        _listOdoCounter.setTotalDigits(9);
        _listOdoCounter.setIsODOObject(true);
        _listOdo = BF.createArrayStringBinding("ListOdo",
               "ListOdo", String.class, this);
        _listOdo.setCobolName("LIST-ODO");
        _listOdo.setByteLength(500);
        _listOdo.setItemByteLength(5);
        _listOdo.setMinOccurs(1);
        _listOdo.setMaxOccurs(100);
        _listOdo.setDependingOn("LIST-ODO--C");

        /* Add children to children list */
        storeCounter(_listOdoCounter);
        getChildrenList().add(_listOdo);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _listOdo */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_listOdo"
                    + " value=" + mValueObject.getListOdo());
        }
        _listOdo.setObjectValue(mValueObject.getListOdo());
        /* For variable size array or list, we make sure any
         * associated counter is updated */
        setCounterValue(_listOdo.getDependingOn(),
                ((List < ? >) mValueObject.getListOdo()).size());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 1:
            ...
            List < String > listListOdo = cast(bindingValue);
            mValueObject.getListOdo().clear();
            mValueObject.getListOdo().addAll(listListOdo);
            break;
         default:
            break;
        }
