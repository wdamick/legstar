...
import com.legstar.test.coxb.lsfilead.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program LSFILEAD.
 * <p/>
 * This host program maps to operation lsfilead.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class LsfileadProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for lsfilead. */
    private static final String  OPERATION_NAME = "lsfilead";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public LsfileadProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new LsfileadHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the LSFILEAD host program.
     * <p/>
