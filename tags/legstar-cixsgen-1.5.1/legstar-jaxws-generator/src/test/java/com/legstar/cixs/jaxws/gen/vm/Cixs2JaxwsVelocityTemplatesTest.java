...
public class Cixs2JaxwsVelocityTemplatesTest extends AbstractTestTemplate {
    ...
    public void testWebXmlGenerationWebService() throws Exception {
        ...
        String resStr = genSource(model,
                ...
                Cixs2JaxwsGenerator.SERVICE_WEB_XML_VLC_TEMPLATE, GEN_WDD_DIR,
                "web.xml");
        assertTrue(resStr
                .contains("<display-name>cultureinfoProxy</display-name>"));
        assertTrue(resStr
                .contains("<description>cultureinfoProxy is a proxy for webservice cultureinfo</description>"));
        assertTrue(resStr
                .contains("<servlet-class>com.legstar.c2ws.servlet.C2wsProxy</servlet-class>"));
        assertTrue(resStr
                .contains("<param-name>operationProxyClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.proxy.invoke.DirectOperationProxy</param-value>"));
        assertTrue(resStr
                .contains("<param-name>requestTransformersClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.test.coxb.cultureinfo.bind.GetInfoTransformers</param-value>"));
        assertTrue(resStr
                .contains("<param-name>responseTransformersClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.test.coxb.cultureinfo.bind.GetInfoResponseTransformers</param-value>"));
        assertTrue(resStr.contains("<param-name>wsdlUrl</param-name>"));
        assertTrue(resStr
                .contains("<param-value>http://localhost:8080/legstar-test-cultureinfo/getinfo?wsdl</param-value>"));
        assertTrue(resStr
                .contains("<param-name>wsdlTargetNamespace</param-name>"));
        assertTrue(resStr
                .contains("<param-value>http://cultureinfo.cases.test.xsdc.legstar.com/</param-value>"));
        assertTrue(resStr.contains("<param-name>wsdlPortName</param-name"));
        assertTrue(resStr
                .contains("<param-value>CultureInfoImplPort</param-value>"));
        assertTrue(resStr.contains("<param-name>wsdlServiceName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>CultureInfoImplService</param-value>"));
        ...
        assertTrue(resStr
                .contains("<param-name>requestJaxbPackageName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.test.coxb.cultureinfo</param-value>"));
        assertTrue(resStr.contains("<param-name>responseJaxbType</param-name>"));
        assertTrue(resStr
                .contains("<param-value>GetInfoResponse</param-value>"));
        assertTrue(resStr
                .contains("<param-name>responseJaxbPackageName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.test.coxb.cultureinfo</param-value>"));
        assertTrue(resStr.contains("<param-name>hostCharset</param-name>"));
        assertTrue(resStr.contains("<param-value>IBM01147</param-value>"));
        assertTrue(resStr
                .contains("<url-pattern>/cultureinfoProxy</url-pattern>"));
    }
    ...
    public void testWebXmlGenerationPojo() throws Exception {
        ...
        String resStr = genSource(model,
                ...
                "web.xml");
        assertTrue(resStr
                .contains("<display-name>jvmqueryProxy</display-name>"));
        assertTrue(resStr
                .contains("<description>jvmqueryProxy is a proxy for pojo jvmquery</description>"));
        assertTrue(resStr
                .contains("<servlet-class>com.legstar.c2ws.servlet.C2wsProxy</servlet-class>"));
        assertTrue(resStr
                .contains("<param-name>operationProxyClassName</param-name>"));
        ...
        assertTrue(resStr
                .contains("<param-name>requestTransformersClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.test.coxb.jvmquery.bind.JvmQueryRequestTransformers</param-value>"));
        assertTrue(resStr
                .contains("<param-name>responseTransformersClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.test.coxb.jvmquery.bind.JvmQueryReplyTransformers</param-value>"));
        assertTrue(resStr.contains("<param-name>hostCharset</param-name>"));
        assertTrue(resStr.contains("<param-value>IBM01147</param-value>"));

        assertTrue(resStr.contains("<!--  Parameters for POJO invoker -->"));
        assertTrue(resStr
                .contains("<param-name>proxyInvokerClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.proxy.invoke.pojo.PojoInvoker</param-value>"));
        assertTrue(resStr.contains("<param-name>pojoClassName</param-name>"));
        assertTrue(resStr
                .contains("<param-value>com.legstar.xsdc.test.cases.jvmquery.JVMQuery</param-value>"));
    ...
    public void testAntWarBuildGeneration() throws Exception {
        ...
        getParameters().put("targetWDDDir",
                "/Legsem/Legstar/Dev/webapp/WEB-INF");
        ...
        assertTrue(resStr
                .contains("<war warfile=\"target/dist/c2ws-cultureinfo.war\""));
        assertTrue(resStr
                .contains("webxml=\"/Legsem/Legstar/Dev/webapp/WEB-INF/web.xml\">"));
        assertTrue(resStr.contains("<classes dir=\"target/classes\">"));
        assertTrue(resStr
                .contains("<include name=\"com/legstar/test/coxb/cultureinfo/*.class\"/>"));
    }
    ...
    public void testAntDeploy() throws Exception {
        ...
        getParameters().put("targetWDDDir",
                "/Legsem/Legstar/Dev/webapp/WEB-INF");
        getParameters().put("targetBinDir",
                "/legstar-cixsgen-cases/target/classes");
        getParameters().put("targetDistDir", "/legstar-cixsgen-cases/target");
        getParameters().put("jaxbBinDir",
                "/legstar-jaxbgen-cases/target/classes");
        getParameters().put("coxbBinDir",
                "/legstar-coxbgen-cases/target/classes");
        ...
        String filename = Cixs2JaxwsGenerator.generateAntDeploy(jaxwsComponent,
                getParameters(), componentAntFilesDir);
        String resStr = getSource(componentAntFilesDir, filename);

        assertTrue(resStr
                .contains("<delete file=\"/Servers/TOMDev/webapps/c2ws-cultureinfo.war\""));
        assertTrue(resStr
                .contains("<copy file=\"/legstar-cixsgen-cases/target/c2ws-cultureinfo.war\""));
