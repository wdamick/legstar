...
public class ClientbinarchtTest extends TestCase {
    ...
    public void testClient() throws BinarchtFault {
        ...
        assertEquals(12345678901234567l, dfhcommareaResp.getLsSignedNative()
                .getLsPs9X18Max());
        assertEquals(-12345678901234567l, dfhcommareaResp.getLsSignedNative()
                .getLsPs9X18Min());
        assertEquals(32767, dfhcommareaResp.getLsSignedNative().getLsPs9X4Max());
        assertEquals(-32768, dfhcommareaResp.getLsSignedNative()
                .getLsPs9X4Min());
        assertEquals(123456789, dfhcommareaResp.getLsSignedNative()
                .getLsPs9X9Max());
        assertEquals(-123456789, dfhcommareaResp.getLsSignedNative()
                .getLsPs9X9Min());
        ...
        assertEquals(1234567890, dfhcommareaResp.getLsUnsignedNative()
                .getLsP9X9Max());
        assertEquals(0l, dfhcommareaResp.getLsUnsignedNative().getLsP9X9Min());
        assertEquals(new BigInteger("123456789012345678"), dfhcommareaResp
                .getLsUnsignedNative().getLsP9X18Max());
