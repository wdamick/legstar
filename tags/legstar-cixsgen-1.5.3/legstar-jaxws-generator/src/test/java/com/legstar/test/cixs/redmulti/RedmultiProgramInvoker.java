...
import com.legstar.test.coxb.redmulti.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program REDMULTI.
 * <p/>
 * This host program maps to operation redmulti.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class RedmultiProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for redmulti. */
    private static final String  OPERATION_NAME = "redmulti";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public RedmultiProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new RedmultiHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the REDMULTI host program.
     * <p/>
