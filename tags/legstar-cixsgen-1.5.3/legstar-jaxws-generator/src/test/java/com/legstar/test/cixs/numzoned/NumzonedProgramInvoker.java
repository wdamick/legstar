...
import com.legstar.test.coxb.numzoned.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program NUMZONED.
 * <p/>
 * This host program maps to operation numzoned.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class NumzonedProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for numzoned. */
    private static final String  OPERATION_NAME = "numzoned";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public NumzonedProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new NumzonedHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the NUMZONED host program.
     * <p/>
