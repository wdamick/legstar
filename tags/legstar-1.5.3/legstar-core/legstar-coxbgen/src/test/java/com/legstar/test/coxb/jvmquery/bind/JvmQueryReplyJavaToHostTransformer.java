...
/**
 * Transforms a JVMQueryReply data object to mainframe data.
 * <p/>
 ...
 *
 */
public class JvmQueryReplyJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public JvmQueryReplyJavaToHostTransformer() {
        super();
    }
     ...
     */
    public JvmQueryReplyJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public JvmQueryReplyJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
