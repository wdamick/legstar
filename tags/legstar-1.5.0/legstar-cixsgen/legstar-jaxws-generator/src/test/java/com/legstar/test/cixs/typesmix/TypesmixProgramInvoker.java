...
import com.legstar.test.coxb.typesmix.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program TYPESMIX.
 * <p/>
 * This host program maps to operation typesmix.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class TypesmixProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for typesmix. */
    private static final String  OPERATION_NAME = "typesmix";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public TypesmixProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new TypesmixHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the TYPESMIX host program.
     * <p/>
