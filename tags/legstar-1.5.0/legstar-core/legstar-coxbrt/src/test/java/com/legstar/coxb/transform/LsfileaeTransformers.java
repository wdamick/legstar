 ...
 *
 */
public class LsfileaeTransformers extends AbstractTransformers {

    
    /**
     * Creates a transformer for each direction at construction time.
     */
    public LsfileaeTransformers() {
        super(new JavaToHostLsfileaeTransformer(),
                new HostToJavaLsfileaeTransformer());
    }
