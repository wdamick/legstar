...
public class ODynamicDataWrapperBinding 
     ...
     */
    public ODynamicDataWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, ODynamicData.class, null, parentBinding, complexItemBinding);
        setMinOccurs(0);
        setMaxOccurs(363);
        setDependingOn("WECH-DYNAMIC-RESPONSE-ROWS");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < ODynamicData >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((ODynamicData) getComplexItemBinding().
            getObjectValue(ODynamicData.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < ODynamicData >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(ODynamicData.class)) {
                mValueObject = (List < ODynamicData >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < ODynamicData > getODynamicData() throws HostException {
        return (List < ODynamicData >) getObjectValue(ODynamicData.class);
    }
