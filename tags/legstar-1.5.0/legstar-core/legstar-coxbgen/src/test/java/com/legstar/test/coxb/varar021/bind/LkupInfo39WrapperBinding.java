...
public class LkupInfo39WrapperBinding 
     ...
     */
    public LkupInfo39WrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, LkupInfo39.class, null, parentBinding, complexItemBinding);
        setMinOccurs(2);
        setMaxOccurs(2);
    }
    ...
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < LkupInfo39 >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((LkupInfo39) getComplexItemBinding().
            getObjectValue(LkupInfo39.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < LkupInfo39 >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(LkupInfo39.class)) {
                mValueObject = (List < LkupInfo39 >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < LkupInfo39 > getLkupInfo39() throws HostException {
        return (List < LkupInfo39 >) getObjectValue(LkupInfo39.class);
    }
