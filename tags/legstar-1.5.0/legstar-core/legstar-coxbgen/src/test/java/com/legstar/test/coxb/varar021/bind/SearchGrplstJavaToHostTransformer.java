...
/**
 * Transforms a SearchGrplst data object to mainframe data.
 * <p/>
 ...
 *
 */
public class SearchGrplstJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public SearchGrplstJavaToHostTransformer() {
        super();
    }
     ...
     */
    public SearchGrplstJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public SearchGrplstJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
