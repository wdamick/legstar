 ...
 * 
 */
public interface ICobolBinaryConverter extends ICobolConverter {
    /**
     ...
     * @throws HostException if conversion fails
     */
    int toHost(ICobolArrayBinaryBinding ce, byte[] hostTarget, int offset,
            int currentOccurs)
    throws HostException;
     ...
     * @throws HostException if conversion fails
     */
    int fromHost(ICobolArrayBinaryBinding ce, byte[] hostSource, int offset,
            int currentOccurs)
    throws HostException;
}
