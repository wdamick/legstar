 ...
 * 
 */
public abstract class AbstractProxyHttpClientTester extends
     ...
     */
    public AbstractProxyHttpClientTester(final String wsName,
            final byte[] bytesRequest) {
        super();
        _wsName = wsName;
    ...
    /**
     * Send HTTP request and check reply.
     * 
    ...
    protected String getServiceURI() {
        return "http://" + getJ2EEHost() + ":8080/c2ws-" + _wsName + "/"
                + _wsName + "Proxy";
    }
