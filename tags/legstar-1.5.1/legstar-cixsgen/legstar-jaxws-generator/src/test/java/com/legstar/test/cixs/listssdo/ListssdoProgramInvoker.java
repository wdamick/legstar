...
import com.legstar.test.coxb.listssdo.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program LISTSSDO.
 * <p/>
 * This host program maps to operation listssdo.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class ListssdoProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for listssdo. */
    private static final String  OPERATION_NAME = "listssdo";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public ListssdoProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new ListssdoHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the LISTSSDO host program.
     * <p/>
