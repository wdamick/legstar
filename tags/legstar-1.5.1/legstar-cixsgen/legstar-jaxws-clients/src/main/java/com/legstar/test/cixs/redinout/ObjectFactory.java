...
public class ObjectFactory {
    ...
    private final static QName _RedinoutHostHeader_QNAME = new QName("http://cixs.test.legstar.com/redinout", "RedinoutHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/redinout", name = "RedinoutHostHeader")
    public JAXBElement<RedinoutHostHeader> createRedinoutHostHeader(RedinoutHostHeader value) {
        return new JAXBElement<RedinoutHostHeader>(_RedinoutHostHeader_QNAME, RedinoutHostHeader.class, null, value);
    }
