...
public class ObjectFactory {
    ...
    private final static QName _LsfileadHostHeader_QNAME = new QName("http://cixs.test.legstar.com/lsfilead", "LsfileadHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/lsfilead", name = "LsfileadHostHeader")
    public JAXBElement<LsfileadHostHeader> createLsfileadHostHeader(LsfileadHostHeader value) {
        return new JAXBElement<LsfileadHostHeader>(_LsfileadHostHeader_QNAME, LsfileadHostHeader.class, null, value);
    }
