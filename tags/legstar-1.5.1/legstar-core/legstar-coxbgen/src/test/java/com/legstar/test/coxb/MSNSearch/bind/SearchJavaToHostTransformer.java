...
/**
 * Transforms a Search data object to mainframe data.
 * <p/>
 ...
 *
 */
public class SearchJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public SearchJavaToHostTransformer() {
        super();
    }
     ...
     */
    public SearchJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public SearchJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
