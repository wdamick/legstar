...
/**
 * Transformer provider for QueryJvmResponse java data object.
 *
 */
public class QueryJvmResponseTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public QueryJvmResponseTransformers() {
        super(new QueryJvmResponseJavaToHostTransformer(),
                new QueryJvmResponseHostToJavaTransformer());
    }
     ...
     */
    public QueryJvmResponse toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryJvmResponse toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryJvmResponse toJava(final byte[] hostData, final int offset,
