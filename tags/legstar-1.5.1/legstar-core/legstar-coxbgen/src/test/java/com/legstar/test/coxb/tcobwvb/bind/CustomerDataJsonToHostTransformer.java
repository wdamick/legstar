 ...
 *  CustomerDataJsonToHostTransformer transformer = new CustomerDataJsonToHostTransformer();
 *  byte[] hostByteArray = transformer.transform(reader);
 * </pre>
 *
 */
public class CustomerDataJsonToHostTransformer extends
     ...
     * @throws HostTransformException if transformer cannot be created
     */
    public CustomerDataJsonToHostTransformer(
