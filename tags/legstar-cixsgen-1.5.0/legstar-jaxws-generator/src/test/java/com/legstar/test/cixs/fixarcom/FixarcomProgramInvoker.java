...
import com.legstar.test.coxb.fixarcom.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program FIXARCOM.
 * <p/>
 * This host program maps to operation fixarcom.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class FixarcomProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for fixarcom. */
    private static final String  OPERATION_NAME = "fixarcom";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public FixarcomProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new FixarcomHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the FIXARCOM host program.
     * <p/>
