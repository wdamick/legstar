...
/**
 * Tests a Web Service adapter using a raw HTTP Client. This one is targeted at
 * axis2.
 * 
 */
public class HttpClientLsfileae100AxisITCase extends
        AbstractAdapterHttpClientTester {
    ...
    public static final String SOAP_REPLY = "<?xml version='1.0' encoding='utf-8'?>"
     ...
     * Construct the test.
     */
    public HttpClientLsfileae100AxisITCase() {
    ...
    protected String getServiceURI() {
        return "http://" + getJ2EEHost() + ":8080/axis2/services/"
                + getWsName() + "Service." + getWsName() + "Port/";
    }
