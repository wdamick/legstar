 ...
 *  QueryLimitJsonToHostTransformer transformer = new QueryLimitJsonToHostTransformer();
 *  byte[] hostByteArray = transformer.transform(reader);
 * </pre>
 *
 */
public class QueryLimitJsonToHostTransformer extends
     ...
     */
    public QueryLimitJsonToHostTransformer() throws HostTransformException {
     ...
     * @throws HostTransformException if transformer cannot be created
     */
    public QueryLimitJsonToHostTransformer(
