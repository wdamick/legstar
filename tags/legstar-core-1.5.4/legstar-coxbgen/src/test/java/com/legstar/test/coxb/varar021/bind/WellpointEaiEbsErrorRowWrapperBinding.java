...
public class WellpointEaiEbsErrorRowWrapperBinding 
             extends CArrayComplexBinding {

    /** Value object to which this cobol complex array element is bound. */
    private List < WellpointEaiEbsErrorRow > mValueObject;
     ...
     */
    public WellpointEaiEbsErrorRowWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, WellpointEaiEbsErrorRow.class, null, parentBinding, complexItemBinding);
        setMinOccurs(0);
        setMaxOccurs(99);
        setDependingOn("WECH-ERROR-ROWS");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < WellpointEaiEbsErrorRow >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((WellpointEaiEbsErrorRow) getComplexItemBinding().
            getObjectValue(WellpointEaiEbsErrorRow.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < WellpointEaiEbsErrorRow >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(WellpointEaiEbsErrorRow.class)) {
                mValueObject = (List < WellpointEaiEbsErrorRow >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < WellpointEaiEbsErrorRow > getWellpointEaiEbsErrorRow() throws HostException {
        return (List < WellpointEaiEbsErrorRow >) getObjectValue(WellpointEaiEbsErrorRow.class);
    }
