...
/**
 * Transformer provider for JVMQueryReply java data object.
 *
 */
public class JvmQueryReplyTransformers extends AbstractTransformers {
     ...
     */
    public JvmQueryReplyTransformers() {
        super(new JvmQueryReplyJavaToHostTransformer(),
                new JvmQueryReplyHostToJavaTransformer());
    }
     ...
     */
    public JVMQueryReply toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public JVMQueryReply toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public JVMQueryReply toJava(final byte[] hostData, final int offset,
