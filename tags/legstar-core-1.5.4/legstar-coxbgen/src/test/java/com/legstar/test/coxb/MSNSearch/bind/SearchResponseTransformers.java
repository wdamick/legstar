...
/**
 * Transformer provider for SearchResponse java data object.
 *
 */
public class SearchResponseTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public SearchResponseTransformers() {
        super(new SearchResponseJavaToHostTransformer(),
                new SearchResponseHostToJavaTransformer());
    }
     ...
     */
    public SearchResponse toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public SearchResponse toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public SearchResponse toJava(final byte[] hostData, final int offset,
