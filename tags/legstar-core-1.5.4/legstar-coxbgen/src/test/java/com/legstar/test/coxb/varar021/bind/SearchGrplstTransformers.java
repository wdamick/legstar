...
/**
 * Transformer provider for SearchGrplst java data object.
 *
 */
public class SearchGrplstTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public SearchGrplstTransformers() {
        super(new SearchGrplstJavaToHostTransformer(),
                new SearchGrplstHostToJavaTransformer());
    }
     ...
     */
    public SearchGrplst toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public SearchGrplst toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public SearchGrplst toJava(final byte[] hostData, final int offset,
