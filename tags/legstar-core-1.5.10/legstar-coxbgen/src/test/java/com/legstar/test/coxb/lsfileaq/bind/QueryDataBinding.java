...
public class QueryDataBinding 
    ...
    /** Child bound to value object property MaxReplies(Short). */
    ...
    */
    ...
    private void initChildren() {
        ...
        _maxReplies = BF.createBinaryBinding("MaxReplies",
               "MaxReplies", Short.class, this);
        _maxReplies.setCobolName("MAX-REPLIES");
        _maxReplies.setByteLength(2);
        _maxReplies.setTotalDigits(4);
        _maxReplies.setIsSigned(true);

        /* Add children to children list */
        getChildrenList().add(_customerName);
        getChildrenList().add(_maxReplies);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _maxReplies */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_maxReplies"
                    + " value=" + mValueObject.getMaxReplies());
        }
        _maxReplies.setObjectValue(mValueObject.getMaxReplies());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 1:
            ...
            mValueObject.setMaxReplies((Short) bindingValue);
            break;
         default:
            break;
        }
