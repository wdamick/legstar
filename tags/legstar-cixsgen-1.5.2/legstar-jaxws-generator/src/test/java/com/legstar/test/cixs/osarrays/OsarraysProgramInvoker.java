...
import com.legstar.test.coxb.osarrays.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program OSARRAYS.
 * <p/>
 * This host program maps to operation osarrays.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class OsarraysProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for osarrays. */
    private static final String  OPERATION_NAME = "osarrays";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public OsarraysProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new OsarraysHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the OSARRAYS host program.
     * <p/>
