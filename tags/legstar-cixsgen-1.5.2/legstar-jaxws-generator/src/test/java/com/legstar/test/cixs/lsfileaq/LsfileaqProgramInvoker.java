...
/**
 * Implements an invoker for program LSFILEAQ.
 * <p/>
 * This host program maps to operation lsfileaq.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class LsfileaqProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for lsfileaq. */
    private static final String  OPERATION_NAME = "lsfileaq";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public LsfileaqProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new LsfileaqHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the LSFILEAQ host program.
     * <p/>
