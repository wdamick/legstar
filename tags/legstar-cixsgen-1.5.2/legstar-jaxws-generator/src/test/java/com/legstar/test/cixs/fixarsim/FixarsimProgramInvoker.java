...
import com.legstar.test.coxb.fixarsim.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program FIXARSIM.
 * <p/>
 * This host program maps to operation fixarsim.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class FixarsimProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for fixarsim. */
    private static final String  OPERATION_NAME = "fixarsim";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public FixarsimProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new FixarsimHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the FIXARSIM host program.
     * <p/>
