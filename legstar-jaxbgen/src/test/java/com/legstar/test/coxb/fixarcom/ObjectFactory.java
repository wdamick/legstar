 ...
 * generated in the com.legstar.test.coxb.fixarcom package. 
...
public class ObjectFactory {
    ...
    private final static QName _Dfhcommarea_QNAME = new QName("http://legstar.com/test/coxb/fixarcom", "Dfhcommarea");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.legstar.test.coxb.fixarcom
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://legstar.com/test/coxb/fixarcom", name = "Dfhcommarea")
