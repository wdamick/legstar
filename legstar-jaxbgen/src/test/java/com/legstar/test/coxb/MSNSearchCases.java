...
public class MSNSearchCases extends TestCase {
    ...
    public static Search getJaxbObjectRequest() {
        ...
        srt.setCount(1);
        ArrayOfSourceRequestRequestsType sr = of
    ...
    public static SearchResponse getJaxbObjectResponse() {
        ...
        result
                .setDescription("Overview. LegStar is the first open-source initiative"
     ...
     */
    public static void checkJavaObjectResponse(
         ...
         * sourceResponse.get(0).getResults().getResult();
    ...
    /**
     * @return a sample serach response as JSON string
     */
    public static String getSearchResponseJson() {
        return "{\"Response\":"
                ...
                + "\"Results\":"
                + "{\"Result\":"
                + "[{\"Title\":\"LegStar - Overview\",\"Description\":\"Overview. LegStar is the first"
                + " open-source initiative in the domain of legacy application integration. This page"
                + " will give you a general idea of LegStar, if you need further ...\","
                + "\"Url\":\"http://www.legsem.com/legstar/\","
                + "\"DisplayUrl\":\"\","
                + "\"CacheUrl\":\"\","
                + "\"Source\":\"\","
                + "\"SearchTags\":\"\","
