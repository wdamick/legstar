...
/**
 * <p>Java class for ArrayscxRequest complex type.
 * 
...
@XmlType(name = "ArrayscxRequest", propOrder = {
    "dfhcommarea"
})
public class ArrayscxRequest {

    @XmlElement(name = "Dfhcommarea", namespace = "http://legstar.com/test/coxb/arrayscx", required = true)
