...
public class ObjectFactory {
    ...
    private final static QName _TypesmixHostHeader_QNAME = new QName("http://cixs.test.legstar.com/typesmix", "TypesmixHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/typesmix", name = "TypesmixHostHeader")
    public JAXBElement<TypesmixHostHeader> createTypesmixHostHeader(TypesmixHostHeader value) {
        return new JAXBElement<TypesmixHostHeader>(_TypesmixHostHeader_QNAME, TypesmixHostHeader.class, null, value);
    }
