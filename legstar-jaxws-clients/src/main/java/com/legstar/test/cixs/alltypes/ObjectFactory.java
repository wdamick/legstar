...
public class ObjectFactory {
    ...
    private final static QName _AlltypesHostHeader_QNAME = new QName("http://cixs.test.legstar.com/alltypes", "AlltypesHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/alltypes", name = "AlltypesHostHeader")
    public JAXBElement<AlltypesHostHeader> createAlltypesHostHeader(AlltypesHostHeader value) {
        return new JAXBElement<AlltypesHostHeader>(_AlltypesHostHeader_QNAME, AlltypesHostHeader.class, null, value);
    }
