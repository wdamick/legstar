...
public class ObjectFactory {
    ...
    private final static QName _FixarnumHostHeader_QNAME = new QName("http://cixs.test.legstar.com/fixarnum", "FixarnumHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/fixarnum", name = "FixarnumHostHeader")
    public JAXBElement<FixarnumHostHeader> createFixarnumHostHeader(FixarnumHostHeader value) {
        return new JAXBElement<FixarnumHostHeader>(_FixarnumHostHeader_QNAME, FixarnumHostHeader.class, null, value);
    }
