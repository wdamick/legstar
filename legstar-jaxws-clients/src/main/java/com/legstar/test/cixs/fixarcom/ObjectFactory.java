...
public class ObjectFactory {
    ...
    private final static QName _FixarcomHostHeader_QNAME = new QName("http://cixs.test.legstar.com/fixarcom", "FixarcomHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/fixarcom", name = "FixarcomHostHeader")
    public JAXBElement<FixarcomHostHeader> createFixarcomHostHeader(FixarcomHostHeader value) {
        return new JAXBElement<FixarcomHostHeader>(_FixarcomHostHeader_QNAME, FixarcomHostHeader.class, null, value);
    }
