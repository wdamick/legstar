...
public class ObjectFactory {
    ...
    private final static QName _ArrayscxHostHeader_QNAME = new QName("http://cixs.test.legstar.com/arrayscx", "ArrayscxHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/arrayscx", name = "ArrayscxHostHeader")
    public JAXBElement<ArrayscxHostHeader> createArrayscxHostHeader(ArrayscxHostHeader value) {
        return new JAXBElement<ArrayscxHostHeader>(_ArrayscxHostHeader_QNAME, ArrayscxHostHeader.class, null, value);
    }
