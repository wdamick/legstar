...
public class ObjectFactory {
    ...
    private final static QName _RedoperaHostHeader_QNAME = new QName("http://cixs.test.legstar.com/redopera", "RedoperaHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/redopera", name = "RedoperaHostHeader")
    public JAXBElement<RedoperaHostHeader> createRedoperaHostHeader(RedoperaHostHeader value) {
        return new JAXBElement<RedoperaHostHeader>(_RedoperaHostHeader_QNAME, RedoperaHostHeader.class, null, value);
    }
