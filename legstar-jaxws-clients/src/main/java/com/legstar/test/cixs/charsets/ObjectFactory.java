...
public class ObjectFactory {
    ...
    private final static QName _CharsetsHostHeader_QNAME = new QName("http://cixs.test.legstar.com/charsets", "CharsetsHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/charsets", name = "CharsetsHostHeader")
    public JAXBElement<CharsetsHostHeader> createCharsetsHostHeader(CharsetsHostHeader value) {
        return new JAXBElement<CharsetsHostHeader>(_CharsetsHostHeader_QNAME, CharsetsHostHeader.class, null, value);
    }
