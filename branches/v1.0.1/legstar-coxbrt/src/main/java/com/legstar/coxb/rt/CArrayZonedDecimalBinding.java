 ...
 * 
*/
public class CArrayZonedDecimalBinding
	...
	/**
	 * Constructor for a cobol array zoned decimal element to java binding.
	 * 
	 ...
	 * @param isSignLeading true if cobol numeric has sign in first byte
	 * @param isSignSeparate true if cobol numeric has a sign in its own byte
	...
	public CArrayZonedDecimalBinding(
		...
		setIsSignLeading(isSignLeading);
		setIsSignSeparate(isSignSeparate);
	}
