...
// Generated on: 2007.04.23 at 05:00:34 PM CEST 
//
...
public class DfhcommareaType {
    ...
    @CobolElement(cobolName = "C-ARRAY-PD", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 7, fractionDigits = 2, minOccurs = 3, maxOccurs = 3)
    protected List<BigDecimal> cArrayPd;
    @XmlElement(name = "CArrayZd", required = true)
    @CobolElement(cobolName = "C-ARRAY-ZD", type = CobolType.ZONED_DECIMAL_ITEM, byteLength = 6, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 6, fractionDigits = 3, minOccurs = 3, maxOccurs = 3)
    protected List<BigDecimal> cArrayZd;
    @XmlElement(name = "CArrayZi", type = Integer.class)
    @CobolElement(cobolName = "C-ARRAY-ZI", type = CobolType.ZONED_DECIMAL_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 4, minOccurs = 3, maxOccurs = 3)
    protected List<Integer> cArrayZi;
    @XmlElement(name = "CArrayBi", type = Long.class)
    @CobolElement(cobolName = "C-ARRAY-BI", type = CobolType.BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9, minOccurs = 3, maxOccurs = 3)
    protected List<Long> cArrayBi;
    @XmlElement(name = "CArrayNi", required = true)
    @CobolElement(cobolName = "C-ARRAY-NI", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 8, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 18, minOccurs = 3, maxOccurs = 3)
