...
public class WsFullwordsType {
    ...
    @CobolElement(cobolName = "WS-P9X9-MIN", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected long wsP9X9Min;
    @XmlElement(name = "WsP9X9Low")
    @CobolElement(cobolName = "WS-P9X9-LOW", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected long wsP9X9Low;
    @XmlElement(name = "WsP9X9High")
    @CobolElement(cobolName = "WS-P9X9-HIGH", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected long wsP9X9High;
    @XmlElement(name = "WsP9X9Max")
    @CobolElement(cobolName = "WS-P9X9-MAX", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
