...
public class WsExtendType {
    ...
    @CobolElement(cobolName = "WS-P9X19", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 10, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 19)
    protected BigInteger wsP9X19;
    @XmlElement(name = "WsP9X31", required = true)
    @CobolElement(cobolName = "WS-P9X31", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 16, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 31)
