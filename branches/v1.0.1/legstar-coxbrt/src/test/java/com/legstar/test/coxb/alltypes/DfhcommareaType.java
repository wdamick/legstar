...
// Generated on: 2007.04.23 at 05:00:17 PM CEST 
//
...
public class DfhcommareaType {
    ...
    @CobolElement(cobolName = "S-BINARY", type = CobolType.OCTET_STREAM_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] sBinary;
    @XmlElement(name = "SShort")
    @CobolElement(cobolName = "S-SHORT", type = CobolType.BINARY_ITEM, byteLength = 2, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 4)
    protected short sShort;
    @XmlElement(name = "SUshort")
    @CobolElement(cobolName = "S-USHORT", type = CobolType.BINARY_ITEM, byteLength = 2, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 4)
    protected int sUshort;
    @XmlElement(name = "SInt")
    @CobolElement(cobolName = "S-INT", type = CobolType.BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected int sInt;
    @XmlElement(name = "SUint")
    @CobolElement(cobolName = "S-UINT", type = CobolType.BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected long sUint;
    @XmlElement(name = "SLong")
    @CobolElement(cobolName = "S-LONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 10, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 18)
    protected long sLong;
    @XmlElement(name = "SUlong")
    @CobolElement(cobolName = "S-ULONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 10, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 18)
    protected long sUlong;
    @XmlElement(name = "SXlong", required = true)
    @CobolElement(cobolName = "S-XLONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 16, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 31)
    protected BigInteger sXlong;
    @XmlElement(name = "SUxlong", required = true)
    @CobolElement(cobolName = "S-UXLONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 16, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 31)
    protected BigInteger sUxlong;
    @XmlElement(name = "SDec", required = true)
    @CobolElement(cobolName = "S-DEC", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 5, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9, fractionDigits = 2)
    protected BigDecimal sDec;
    @XmlElement(name = "SFloat")
    @CobolElement(cobolName = "S-FLOAT", type = CobolType.SINGLE_FLOAT_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false)
    protected float sFloat;
    @XmlElement(name = "SDouble")
    @CobolElement(cobolName = "S-DOUBLE", type = CobolType.DOUBLE_FLOAT_ITEM, byteLength = 8, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false)
    ...
    @CobolElement(cobolName = "A-SHORT", type = CobolType.BINARY_ITEM, byteLength = 2, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 4, minOccurs = 2, maxOccurs = 2)
    protected List<Short> aShort;
    @XmlElement(name = "AUshort", type = Integer.class)
    @CobolElement(cobolName = "A-USHORT", type = CobolType.BINARY_ITEM, byteLength = 2, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 4, minOccurs = 2, maxOccurs = 2)
    protected List<Integer> aUshort;
    @XmlElement(name = "AInt", type = Integer.class)
    @CobolElement(cobolName = "A-INT", type = CobolType.BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 9, minOccurs = 2, maxOccurs = 2)
    protected List<Integer> aInt;
    @XmlElement(name = "AUint", type = Long.class)
    @CobolElement(cobolName = "A-UINT", type = CobolType.BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9, minOccurs = 2, maxOccurs = 2)
    protected List<Long> aUint;
    @XmlElement(name = "ALong", type = Long.class)
    @CobolElement(cobolName = "A-LONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 10, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 18, minOccurs = 2, maxOccurs = 2)
    protected List<Long> aLong;
    @XmlElement(name = "AUlong", type = Long.class)
    @CobolElement(cobolName = "A-ULONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 10, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 18, minOccurs = 2, maxOccurs = 2)
    protected List<Long> aUlong;
    @XmlElement(name = "AXlong", required = true)
    @CobolElement(cobolName = "A-XLONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 16, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 31, minOccurs = 2, maxOccurs = 2)
    protected List<BigInteger> aXlong;
    @XmlElement(name = "AUxlong", required = true)
    @CobolElement(cobolName = "A-UXLONG", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 16, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 31, minOccurs = 2, maxOccurs = 2)
    protected List<BigInteger> aUxlong;
    @XmlElement(name = "ADec", required = true)
    @CobolElement(cobolName = "A-DEC", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 5, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9, fractionDigits = 2, minOccurs = 2, maxOccurs = 2)
    protected List<BigDecimal> aDec;
    @XmlElement(name = "AFloat", type = Float.class)
    @CobolElement(cobolName = "A-FLOAT", type = CobolType.SINGLE_FLOAT_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, minOccurs = 2, maxOccurs = 2)
    protected List<Float> aFloat;
    @XmlElement(name = "ADouble", type = Double.class)
    @CobolElement(cobolName = "A-DOUBLE", type = CobolType.DOUBLE_FLOAT_ITEM, byteLength = 8, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, minOccurs = 2, maxOccurs = 2)
