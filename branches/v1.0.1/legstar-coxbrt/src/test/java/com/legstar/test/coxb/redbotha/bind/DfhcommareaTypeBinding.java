...
public class DfhcommareaTypeBinding 
    ...
    /** Child property CNumericChoiceBinding of choice type. */
    public CNumericChoiceBinding cNumeric;
    ...
    public final void initChildren() {
        ...
        cNumeric = new CNumericChoiceBinding(this);
    ...
    public final void prepareChildren() throws HostException {
        ...
        /* Child cNumeric is a choice. Because JAXB does not create
         * objects for choices, we propagate the parent object. */
        cNumeric.setJaxbObject(mJaxbObject);
        cNumeric.setObjectFactory(mObjectFactory);
