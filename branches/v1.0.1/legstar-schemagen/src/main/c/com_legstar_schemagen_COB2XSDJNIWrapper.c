...
int prolog (JNIEnv  *env, jobject obj, jobject inVars)
{
	_sMessage[0] = '\0';
...
int getCobolOptions(JNIEnv  *env, jobject inVars)
{
	jclass jcInVars;
...
int getXsdOptions(JNIEnv  *env, jobject inVars)
{
	jclass jcInVars;
	jobject joXsdOptions;
	jfieldID jfID;
	char* replaceMinusChar;
    jthrowable exc;
...
int epilog (JNIEnv  *env, jobject obj,  jobject outVars)
{
     jthrowable exc;
