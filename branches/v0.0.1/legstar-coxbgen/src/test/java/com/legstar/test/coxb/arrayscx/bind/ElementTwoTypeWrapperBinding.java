...
public class ElementTwoTypeWrapperBinding 
    ...
    private ElementTwoTypeBinding elementTwo;
        
    /** Java object to which this cobol complex array element is bound. */
    private List < ElementTwoType > mJaxbObject;
     ...
     */
    public ElementTwoTypeWrapperBinding() {
        this(null, null, null);
    }
    ...
    public ElementTwoTypeWrapperBinding(
        final ObjectFactory objectFactory,
        final List < ElementTwoType > jaxbObject) {
    ...
    public ElementTwoTypeWrapperBinding(
        ...
        super(JAVA_NAME, JAVA_TYPE, parentObject, new ElementTwoTypeBinding(parentObject), MIN_OCCURS, MAX_OCCURS);
    ...
    public final void initChildren() {
        elementTwo = (ElementTwoTypeBinding) getComplexBinding();
    ...
    public final void createBoundObject() throws HostException {
        setJaxbObject(new ArrayList < ElementTwoType >());
    }
    ...
    public final void getValuesFromBoundItem(
        final int index) throws HostException {
        elementTwo.setJaxbObject(mJaxbObject.get(index));
    }
       
    /** {@inheritDoc} */
    public final void setBoundItemValues(
        final int index) throws HostException {
        mJaxbObject.add(elementTwo.getJaxbObject());
    }
     ...
     */
    public final List < ElementTwoType > getJaxbObject() {
        return mJaxbObject;
    }
