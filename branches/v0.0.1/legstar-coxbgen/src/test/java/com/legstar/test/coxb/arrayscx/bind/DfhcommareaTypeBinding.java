...
public class DfhcommareaTypeBinding 
    ...
    /** Child property TableThreeTypeBinding of complex type. */
    public TableThreeTypeBinding tableThree;
            
    /** Child property TableRedefTypeWrapperBinding of complexArray type. */
    public TableRedefTypeWrapperBinding tableRedef;
    ...
    public final void initChildren() {
        ...
        tableThree = new TableThreeTypeBinding(this);
        tableRedef = new TableRedefTypeWrapperBinding(this);
        
        /* Add children to children list */
           
        getChildrenList().add(tableThree);
        getChildrenList().add(tableRedef);
    }
    ...
    public final void prepareChildren() throws HostException {
        ...
        /* Pass on the JAXB factory to child tableThree  */
        tableThree.setObjectFactory(mObjectFactory);
    ...
    public final void getValuesFromBoundObject() throws HostException {
        ...
        if (mJaxbObject.getTableThree() != null) {
            /* Set value from tableThree*/
            tableThree.setJaxbObject(mJaxbObject.getTableThree());
            
        } else {
            tableThree.setJaxbObject(mObjectFactory.createTableThreeType());
        }
                            
        if (mJaxbObject.getTableRedef() != null) {
            /* Set value from tableRedef*/
            tableRedef.setJaxbObject(mJaxbObject.getTableRedef());
            
        } else {
            tableRedef.createBoundObject();
        }
    ...
    public final void setBoundObjectValue(final int index) throws HostException {
        ...
        switch (index) {
        case 0:
            setBoundObjectValueTableThree();
            break;
        case 1:
            setBoundObjectValueTableRedef();
            break;
        }
    }
            
    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueTableThree() throws HostException {
    
        /* Set value of complex child tableThree*/
        mJaxbObject.setTableThree(tableThree.getJaxbObject());
        
    }

    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueTableRedef() throws HostException {
    
        /* Set value of complex array child tableRedef*/
        mJaxbObject.getTableRedef().clear();
        mJaxbObject.getTableRedef().addAll(tableRedef.getJaxbObject());
