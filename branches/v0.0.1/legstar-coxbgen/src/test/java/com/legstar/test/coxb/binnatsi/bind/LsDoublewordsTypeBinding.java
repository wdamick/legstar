...
public class LsDoublewordsTypeBinding 
    ...
    /** Child property CBinaryBinding of simple type. */
    public CBinaryBinding lsPs9X18Low;
            
    /** Child property CBinaryBinding of simple type. */
    public CBinaryBinding lsPs9X18High;
    ...
    public final void initChildren() {
        ...
        lsPs9X18Low = new CBinaryBinding("lsPs9X18Low", 8, 18, 0, true);
        lsPs9X18Low.setCobolName("LS-PS9X18-LOW");
        lsPs9X18High = new CBinaryBinding("lsPs9X18High", 8, 18, 0, true);
        lsPs9X18High.setCobolName("LS-PS9X18-HIGH");
        ...
        getChildrenList().add(lsPs9X18Low);
        getChildrenList().add(lsPs9X18High);
    ...
    public final void getValuesFromBoundObject() throws HostException {
        ...
        if (mJaxbObject.getLsPs9X18Low() != 0L) {
            /* Set value from lsPs9X18Low*/
            lsPs9X18Low.setValue(new BigDecimal(mJaxbObject.getLsPs9X18Low()));
        
        }
                
        if (mJaxbObject.getLsPs9X18High() != 0L) {
            /* Set value from lsPs9X18High*/
            lsPs9X18High.setValue(new BigDecimal(mJaxbObject.getLsPs9X18High()));
    ...
    public final void setBoundObjectValue(final int index) throws HostException {
        ...
        case 0:
            ...
            break;
        case 1:
            setBoundObjectValueLsPs9X18Low();
            break;
        case 2:
            setBoundObjectValueLsPs9X18High();
            break;
        case 3:
    ...
    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueLsPs9X18Low() throws HostException {
    
        if (lsPs9X18Low.getValue() != null) {
            
            /* Set value of lsPs9X18Low*/
            mJaxbObject.setLsPs9X18Low(lsPs9X18Low.getValue().longValueExact());
    ...
    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueLsPs9X18High() throws HostException {
    
        if (lsPs9X18High.getValue() != null) {
            
            /* Set value of lsPs9X18High*/
            mJaxbObject.setLsPs9X18High(lsPs9X18High.getValue().longValueExact());
