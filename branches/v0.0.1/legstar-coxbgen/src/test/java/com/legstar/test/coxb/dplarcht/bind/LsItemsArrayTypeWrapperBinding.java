...
public class LsItemsArrayTypeWrapperBinding 
    ...
    private static final String JAVA_NAME = "lsItemsArrayWrapper";
    ...
    private static final int MAX_OCCURS = 500;
    
    
    /** Variable giving the actual array size. */
    private static final String DEPENDING_ON = "LS-ITEMS-COUNT";
    
    
    /** Binding for one of the complex array items. */
    private LsItemsArrayTypeBinding lsItemsArray;
    ...
    public LsItemsArrayTypeWrapperBinding(
        final ObjectFactory objectFactory,
        final List < LsItemsArrayType > jaxbObject) {
    ...
    public LsItemsArrayTypeWrapperBinding(
        ...
        super(JAVA_NAME, JAVA_TYPE, parentObject, new LsItemsArrayTypeBinding(parentObject), MIN_OCCURS, MAX_OCCURS);
    ...
    public final void initChildren() {
        lsItemsArray = (LsItemsArrayTypeBinding) getComplexBinding();
    ...
    public final void createBoundObject() throws HostException {
        setJaxbObject(new ArrayList < LsItemsArrayType >());
    }
    ...
    public final void getValuesFromBoundItem(
        final int index) throws HostException {
        lsItemsArray.setJaxbObject(mJaxbObject.get(index));
    }
       
    /** {@inheritDoc} */
    public final void setBoundItemValues(
        final int index) throws HostException {
        mJaxbObject.add(lsItemsArray.getJaxbObject());
    }
     ...
     */
    public final List < LsItemsArrayType > getJaxbObject() {
        return mJaxbObject;
    }
