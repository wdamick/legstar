...
/**
 * This interface groups methods that are common to all cobol national elements
...
public interface ICobolNationalBinding extends ICobolBinding {
	 ...
	 */
	String getValue() throws HostException;
	 ...
	 */
	void setValue(String value) throws HostException;
