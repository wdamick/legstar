...
import com.legstar.test.coxb.ardo03.Ardo03Record;

/**
 * Transformer provider for Ardo03Record java data object.
 *
 */
public class Ardo03RecordTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public Ardo03RecordTransformers() {
        super(new Ardo03RecordJavaToHostTransformer(),
                new Ardo03RecordHostToJavaTransformer());
    }
     ...
     */
    public Ardo03Record toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public Ardo03Record toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public Ardo03Record toJava(final byte[] hostData, final int offset,
