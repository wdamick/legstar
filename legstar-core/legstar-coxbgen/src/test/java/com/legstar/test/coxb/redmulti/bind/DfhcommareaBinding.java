...
public class DfhcommareaBinding 
    ...
    public static final int BYTE_LENGTH = 206;
    
    /** Child bound to value object property COutputType(String). */
    public ICobolStringBinding _cOutputType;
    /** Unbound child. */
    public ICobolChoiceBinding _cDataChoice;
    ...
    */
    ...
    private void initChildren() {
        ...
        _cOutputType = BF.createStringBinding("COutputType",
               "COutputType", String.class, this);
        _cOutputType.setCobolName("C-OUTPUT-TYPE");
        _cOutputType.setByteLength(6);
        _cDataChoice = new CDataChoiceBinding("CDataChoice", this);
        _cDataChoice.setCobolName("C-DATA");
        _cDataChoice.setByteLength(200);
        _cDataChoice.setUnmarshalChoiceStrategyClassName(
            "com.legstar.coxb.cust.redmulti.ChoiceSelector");

        /* Add children to children list */
        getChildrenList().add(_cOutputType);
        getChildrenList().add(_cDataChoice);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _cOutputType */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_cOutputType"
                    + " value=" + mValueObject.getCOutputType());
        }
        _cOutputType.setObjectValue(mValueObject.getCOutputType());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 0:
            ...
            mValueObject.setCOutputType((String) bindingValue);
            break;
        case 1:
            break;
         default:
