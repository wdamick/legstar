...
public class JvmqueryWsCases extends TestCase {
    ...
    public static QueryJvmResponse getJavaObject() {
        ...
        jvmQueryReply
                .getEnvVarValues()
                .add("D:\\Legsem\\Legstar\\jboss\\mlittle\\product\\build\\jbossesb-server-4.4.GA");
        jvmQueryReply.getEnvVarValues()
                .add("C:\\Program Files\\Java\\jdk1.6.0");
    ...
    public static void checkJavaObject(final QueryJvmResponse queryJvmResponse) {
        ...
        assertEquals("D:\\Legsem\\Legstar\\jboss\\mlittle\\", queryJvmResponse
                .getReturn().getEnvVarValues().get(0));
        assertEquals("C:\\Program Files\\Java\\jdk1.6.0", queryJvmResponse
                .getReturn().getEnvVarValues().get(1));
    }
