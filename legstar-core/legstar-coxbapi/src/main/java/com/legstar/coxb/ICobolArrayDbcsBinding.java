...
/**
 * This interface groups methods that are common to all cobol array DBCS
 * elements (PIC G OCCURS USAGE DISPLAY-1).
 *
 * @author Fady Moussallam
 * 
 */
public interface ICobolArrayDbcsBinding extends ICobolArrayBinding {
