...
public class UnmarshalLsfilealTest extends TestCase {
	...
	public void testLsfileal() throws HostException {
		...
		com.legstar.test.coxb.lsfileal.bind.ReplyDataTypeBinding ccem = new com.legstar.test.coxb.lsfileal.bind.ReplyDataTypeBinding(objectFactory);
		ccem.accept(uv);
		com.legstar.test.coxb.lsfileal.ReplyDataType replyData = ccem.getJaxbObject();
	...
	public void testLsfilealWithError() throws HostException {
