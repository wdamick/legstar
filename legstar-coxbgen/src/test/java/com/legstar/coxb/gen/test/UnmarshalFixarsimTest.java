...
public class UnmarshalFixarsimTest extends TestCase {
	...
	public void testFixarsim() throws HostException {
		...
		com.legstar.test.coxb.fixarsim.bind.DfhcommareaTypeBinding ccem = new com.legstar.test.coxb.fixarsim.bind.DfhcommareaTypeBinding(objectFactory);
		ccem.accept(uv);
		com.legstar.test.coxb.fixarsim.DfhcommareaType dfhcommareaType = ccem.getJaxbObject();
