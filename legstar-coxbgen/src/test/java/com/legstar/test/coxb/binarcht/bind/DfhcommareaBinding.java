...
public class DfhcommareaBinding 
    ...
    /** Child bound to value object property LsSignedNative(LsSignedNative). */
    public ICobolComplexBinding _lsSignedNative;
    ...
    */
    ...
    private void initChildren() {
        ...
        _lsUnsignedNative.setByteLength(28);
        _lsSignedNative = new LsSignedNativeBinding("LsSignedNative",
               "LsSignedNative", this, null);
        _lsSignedNative.setCobolName("LS-SIGNED-NATIVE");
        _lsSignedNative.setByteLength(28);

        /* Add children to children list */
        getChildrenList().add(_lsUnsignedNative);
        getChildrenList().add(_lsSignedNative);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _lsSignedNative */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_lsSignedNative"
                    + " value=" + mValueObject.getLsSignedNative());
        }
        _lsSignedNative.setObjectValue(mValueObject.getLsSignedNative());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 0:
            ...
            break;
        case 1:
            bindingValue = child.getObjectValue(LsSignedNative.class);
            mValueObject.setLsSignedNative((LsSignedNative) bindingValue);
            break;
         default:
            break;
        }
