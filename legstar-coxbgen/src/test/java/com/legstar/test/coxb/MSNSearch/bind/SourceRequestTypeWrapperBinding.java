...
public class SourceRequestTypeWrapperBinding 
     ...
     */
    public SourceRequestTypeWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, SourceRequestType.class, null, parentBinding, complexItemBinding);
        setMinOccurs(0);
        setMaxOccurs(10);
        setDependingOn("SourceRequest--C");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < SourceRequestType >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((SourceRequestType) getComplexItemBinding().
            getObjectValue(SourceRequestType.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < SourceRequestType >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(SourceRequestType.class)) {
                mValueObject = (List < SourceRequestType >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < SourceRequestType > getSourceRequestType() throws HostException {
        return (List < SourceRequestType >) getObjectValue(SourceRequestType.class);
    }
