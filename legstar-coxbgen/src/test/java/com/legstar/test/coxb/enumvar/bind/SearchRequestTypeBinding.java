...
public class SearchRequestTypeBinding 
    ...
    private static final int BYTE_LENGTH = 74;
    ...
    /** Child bound to value object property SearchWeight(BigInteger). */
    public ICobolBinaryBinding _searchWeight;
    ...
    */
    ...
    private void initChildren() {
        ...
        _searchWeight = BF.createBinaryBinding("SearchWeight",
               "SearchWeight", BigInteger.class, this);
        _searchWeight.setCobolName("SEARCHWEIGHT");
        _searchWeight.setByteLength(2);
        _searchWeight.setTotalDigits(4);

        /* Add children to children list */
        getChildrenList().add(_appID);
        getChildrenList().add(_safeSearch);
        getChildrenList().add(_searchWeight);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _searchWeight */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_searchWeight"
                    + " value=" + mValueObject.getSearchWeight());
        }
        _searchWeight.setObjectValue(mValueObject.getSearchWeight());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 2:
            ...
            mValueObject.setSearchWeight((BigInteger) bindingValue);
            break;
         default:
            break;
        }
