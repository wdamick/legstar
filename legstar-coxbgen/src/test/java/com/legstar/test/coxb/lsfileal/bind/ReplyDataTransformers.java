...
/**
 * Transformer provider for ReplyData java data object.
 *
 */
public class ReplyDataTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public ReplyDataTransformers() {
        super(new ReplyDataJavaToHostTransformer(),
                new ReplyDataHostToJavaTransformer());
    }
     ...
     */
    public ReplyData toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public ReplyData toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public ReplyData toJava(final byte[] hostData, final int offset,
