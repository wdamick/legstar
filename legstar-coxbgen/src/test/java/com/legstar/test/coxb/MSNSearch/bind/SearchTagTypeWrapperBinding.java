...
public class SearchTagTypeWrapperBinding 
     ...
     */
    public SearchTagTypeWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, SearchTagType.class, null, parentBinding, complexItemBinding);
        setMinOccurs(0);
        setMaxOccurs(10);
        setDependingOn("SearchTag--C");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < SearchTagType >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((SearchTagType) getComplexItemBinding().
            getObjectValue(SearchTagType.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < SearchTagType >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(SearchTagType.class)) {
                mValueObject = (List < SearchTagType >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < SearchTagType > getSearchTagType() throws HostException {
        return (List < SearchTagType >) getObjectValue(SearchTagType.class);
    }
