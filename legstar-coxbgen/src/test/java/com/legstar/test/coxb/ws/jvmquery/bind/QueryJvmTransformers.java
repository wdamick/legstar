...
/**
 * Transformer provider for QueryJvm java data object.
 *
 */
public class QueryJvmTransformers extends AbstractTransformers {
    ...
    public QueryJvmTransformers() {
        super(new QueryJvmJavaToHostTransformer(),
                new QueryJvmHostToJavaTransformer());
    }
     ...
     */
    public QueryJvm toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryJvm toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryJvm toJava(final byte[] hostData, final int offset,
