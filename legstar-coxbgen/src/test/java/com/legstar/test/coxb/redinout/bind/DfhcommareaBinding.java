...
public class DfhcommareaBinding 
    ...
    private static final int BYTE_LENGTH = 502;
    
    /** Child bound to value object property CNumeric(Integer). */
    public ICobolBinaryBinding _cNumeric;
    /** Unbound child. */
    public ICobolChoiceBinding _cBufferChoice;
    ...
    */
    ...
    private void initChildren() {
        ...
        _cNumeric = BF.createBinaryBinding("CNumeric",
               "CNumeric", Integer.class, this);
        _cNumeric.setCobolName("C-NUMERIC");
        _cNumeric.setByteLength(2);
        _cNumeric.setTotalDigits(4);
        _cBufferChoice = new CBufferChoiceBinding("CBufferChoice", this);
        _cBufferChoice.setCobolName("C-BUFFER");
        _cBufferChoice.setByteLength(500);
        _cBufferChoice.setUnmarshalChoiceStrategyClassName(
            "com.legstar.coxb.cust.redinout.ChoiceSelector");

        /* Add children to children list */
        getChildrenList().add(_cNumeric);
        getChildrenList().add(_cBufferChoice);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _cNumeric */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_cNumeric"
                    + " value=" + mValueObject.getCNumeric());
        }
        _cNumeric.setObjectValue(mValueObject.getCNumeric());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 0:
            ...
            mValueObject.setCNumeric((Integer) bindingValue);
            break;
        case 1:
            break;
         default:
