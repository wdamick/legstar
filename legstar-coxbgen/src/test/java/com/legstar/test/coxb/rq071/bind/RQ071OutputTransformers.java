...
/**
 * Transformer provider for RQ071Output java data object.
 *
 */
public class RQ071OutputTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public RQ071OutputTransformers() {
        super(new RQ071OutputJavaToHostTransformer(),
                new RQ071OutputHostToJavaTransformer());
    }
     ...
     */
    public RQ071Output toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public RQ071Output toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public RQ071Output toJava(final byte[] hostData, final int offset,
