...
public class CustomerWrapperBinding 
     ...
     */
    public CustomerWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, Customer.class, null, parentBinding, complexItemBinding);
        setMinOccurs(1);
        setMaxOccurs(100);
        setDependingOn("REPLY-COUNT");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < Customer >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((Customer) getComplexItemBinding().
            getObjectValue(Customer.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < Customer >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(Customer.class)) {
                mValueObject = (List < Customer >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < Customer > getCustomer() throws HostException {
        return (List < Customer >) getObjectValue(Customer.class);
    }
