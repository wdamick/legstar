...
/**
 * Transformer provider for Search java data object.
 *
 */
public class SearchTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public SearchTransformers() {
        super(new SearchJavaToHostTransformer(),
                new SearchHostToJavaTransformer());
    }
     ...
     */
    public Search toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public Search toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public Search toJava(final byte[] hostData, final int offset,
