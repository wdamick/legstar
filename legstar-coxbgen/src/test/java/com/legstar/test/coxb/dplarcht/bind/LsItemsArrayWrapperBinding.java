...
public class LsItemsArrayWrapperBinding 
     ...
     */
    public LsItemsArrayWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, LsItemsArray.class, null, parentBinding, complexItemBinding);
        setMinOccurs(1);
        setMaxOccurs(500);
    ...
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < LsItemsArray >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((LsItemsArray) getComplexItemBinding().
            getObjectValue(LsItemsArray.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < LsItemsArray >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(LsItemsArray.class)) {
                mValueObject = (List < LsItemsArray >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < LsItemsArray > getLsItemsArray() throws HostException {
        return (List < LsItemsArray >) getObjectValue(LsItemsArray.class);
    }
