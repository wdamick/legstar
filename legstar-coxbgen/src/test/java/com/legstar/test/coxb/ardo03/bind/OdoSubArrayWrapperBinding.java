...
public class OdoSubArrayWrapperBinding 
     ...
     */
    public OdoSubArrayWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, OdoSubArray.class, null, parentBinding, complexItemBinding);
        setMinOccurs(-1);
        setMaxOccurs(5);
        setDependingOn("ODO-SUB-COUNTER");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < OdoSubArray >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((OdoSubArray) getComplexItemBinding().
            getObjectValue(OdoSubArray.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < OdoSubArray >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(OdoSubArray.class)) {
                mValueObject = (List < OdoSubArray >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < OdoSubArray > getOdoSubArray() throws HostException {
        return (List < OdoSubArray >) getObjectValue(OdoSubArray.class);
    }
