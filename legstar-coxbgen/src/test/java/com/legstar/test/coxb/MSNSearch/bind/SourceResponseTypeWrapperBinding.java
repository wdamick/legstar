...
public class SourceResponseTypeWrapperBinding 
     ...
     */
    public SourceResponseTypeWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, SourceResponseType.class, null, parentBinding, complexItemBinding);
        setMinOccurs(0);
        setMaxOccurs(10);
        setDependingOn("SourceResponse--C");
    }

    /** {@inheritDoc} */
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < SourceResponseType >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((SourceResponseType) getComplexItemBinding().
            getObjectValue(SourceResponseType.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < SourceResponseType >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(SourceResponseType.class)) {
                mValueObject = (List < SourceResponseType >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < SourceResponseType > getSourceResponseType() throws HostException {
        return (List < SourceResponseType >) getObjectValue(SourceResponseType.class);
    }
