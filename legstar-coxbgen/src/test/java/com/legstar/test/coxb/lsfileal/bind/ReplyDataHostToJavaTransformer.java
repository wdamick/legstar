...
/**
 * Transforms mainframe data to a ReplyData data object.
 * <p/>
 * This is a typical use of this class:
 * <pre>
 *  ReplyDataHostToJavaTransformer transformer = new ReplyDataHostToJavaTransformer();
 *  ReplyData javaValue = (ReplyData) transformer.transform(hostByteArray);
 * </pre>
 *
 */
public class ReplyDataHostToJavaTransformer extends AbstractHostToJavaTransformer {

    
    /**
     * Create a Host to Java transformer using default COBOL parameters.
     */
    public ReplyDataHostToJavaTransformer() {
        super();
    }
     ...
     */
    public ReplyDataHostToJavaTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public ReplyDataHostToJavaTransformer(final String hostCharset) {
        super(hostCharset);
    }
