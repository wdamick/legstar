...
/**
 * Transformer provider for QueryData java data object.
 *
 */
public class QueryDataTransformers extends AbstractTransformers {
    ...
    public QueryDataTransformers() {
        super(new QueryDataJavaToHostTransformer(),
                new QueryDataHostToJavaTransformer());
    }
     ...
     */
    public QueryData toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryData toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryData toJava(final byte[] hostData, final int offset,
