...
public class DfhcommareaBinding 
    ...
    /** Child bound to value object property SBinary(String). */
    public ICobolStringBinding _sBinary;
    ...
    */
    ...
    private void initChildren() {
        ...
        _sBinary = BF.createStringBinding("SBinary",
               "SBinary", String.class, this);
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 1:
            bindingValue = child.getObjectValue(String.class);
            mValueObject.setSBinary((String) bindingValue);
            break;
        case 2:
            bindingValue = child.getObjectValue(String.class);
