...
public class DfhcommareaBinding 
    ...
    private static final int BYTE_LENGTH = 218;
    
    /** Child bound to value object property CFunction(String). */
    public ICobolStringBinding _cFunction;
    /** Unbound child. */
    ...
    */
    ...
    private void initChildren() {
        ...
        _cFunction = BF.createStringBinding("CFunction",
               "CFunction", String.class, this);
        _cFunction.setCobolName("C-FUNCTION");
        _cFunction.setByteLength(18);
        ...
        getChildrenList().add(_cFunction);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _cFunction */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_cFunction"
                    + " value=" + mValueObject.getCFunction());
        }
        _cFunction.setObjectValue(mValueObject.getCFunction());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 0:
            ...
            mValueObject.setCFunction((String) bindingValue);
            break;
        case 1:
            break;
         default:
