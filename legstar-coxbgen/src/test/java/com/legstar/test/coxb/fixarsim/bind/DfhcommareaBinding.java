...
public class DfhcommareaBinding 
    ...
    /** Child bound to value object property CArray(String). */
    public ICobolArrayStringBinding _cArray;
    ...
    */
    ...
    private void initChildren() {
        ...
        _cArray = BF.createArrayStringBinding("CArray",
               "CArray", String.class, this);
        _cArray.setCobolName("C-ARRAY");
        _cArray.setByteLength(15);
        _cArray.setItemByteLength(5);
        _cArray.setMinOccurs(3);
        _cArray.setMaxOccurs(3);

        /* Add children to children list */
        getChildrenList().add(_cArray);
    ...
    public void setChildrenValues() throws HostException {
        ...
        /* Get Value object property _cArray */
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_cArray"
                    + " value=" + mValueObject.getCArray());
        }
        _cArray.setObjectValue(mValueObject.getCArray());
     }
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 0:
            ...
            List < String > listCArray = cast(bindingValue);
            mValueObject.getCArray().clear();
            mValueObject.getCArray().addAll(listCArray);
            break;
         default:
            break;
        }
