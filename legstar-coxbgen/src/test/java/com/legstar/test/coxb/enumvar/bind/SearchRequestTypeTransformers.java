...
/**
 * Transformer provider for SearchRequestType java data object.
 *
 */
public class SearchRequestTypeTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public SearchRequestTypeTransformers() {
        super(new SearchRequestTypeJavaToHostTransformer(),
                new SearchRequestTypeHostToJavaTransformer());
    }
     ...
     */
    public SearchRequestType toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public SearchRequestType toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public SearchRequestType toJava(final byte[] hostData, final int offset,
