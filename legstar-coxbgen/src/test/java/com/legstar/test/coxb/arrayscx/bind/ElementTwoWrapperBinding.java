...
public class ElementTwoWrapperBinding 
     ...
     */
    public ElementTwoWrapperBinding(
            final String bindingName,
            final String fieldName,
            final ICobolComplexBinding parentBinding,
            final ICobolComplexBinding complexItemBinding) {
        
        super(bindingName, fieldName, ElementTwo.class, null, parentBinding, complexItemBinding);
        setMinOccurs(3);
        setMaxOccurs(3);
    }
    ...
    public void createValueObject() throws HostException {
        mValueObject = new ArrayList < ElementTwo >();
    }
    ...
    public void addPropertyValue(
        ...
        mValueObject.add((ElementTwo) getComplexItemBinding().
            getObjectValue(ElementTwo.class));
    }
    ...
    public void setObjectList(
            final List < ? > list) {
        mValueObject = (List < ElementTwo >) list;
    }
    ...
    public void setObjectValue(final Object value) throws HostException {
        ...
        if (value instanceof List) {
            ...
            if (item.getClass().equals(ElementTwo.class)) {
                mValueObject = (List < ElementTwo >) value;
                return;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public List < ElementTwo > getElementTwo() throws HostException {
        return (List < ElementTwo >) getObjectValue(ElementTwo.class);
    }
