...
/**
 * Implementation of a component generator which basically hands over control to
 * the Jaxws2Cixs wizard.
 */
public class Jaxws2CixsGeneratorWizardLauncher extends
    ...
    public static ServiceRegistration register(final BundleContext context) {
        return context.registerService(
                ...
                new Jaxws2CixsGeneratorWizardLauncher(), null);
