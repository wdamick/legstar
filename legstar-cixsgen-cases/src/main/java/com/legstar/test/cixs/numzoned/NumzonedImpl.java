...
import com.legstar.test.coxb.numzoned.bind.DfhcommareaTypeBinding;
...
public class NumzonedImpl implements Numzoned {
    ...
    /** Properties for operation numzoned. */
    private static final String  NUMZONED_PROP_FILE = "numzoned.properties";

    /** {@inheritDoc} */
    public final DfhcommareaType numzoned(
        ...
        try {
            ...
            HostInvoker mInvoker = HostInvokerFactory.createHostInvoker(
                mConfigFileName, getAddress(hostHeader), NUMZONED_PROP_FILE);
            ...
            /* Call remote program */
            mInvoker.invoke((hostHeader == null) ? "numzoned" 
            ...
            reportNumzonedFaultException(e,
    ...
    * @throws NumzonedFault the fault exception
    */
    private void reportNumzonedFaultException(
        final Exception e,
        final String text) throws NumzonedFault {
        ...
        faultInfo.setDetail("Operation="
                + "Numzoned"
                + " Package="
                + "com.legstar.test.cixs.numzoned");
        throw (new NumzonedFault(text + ' ' 
