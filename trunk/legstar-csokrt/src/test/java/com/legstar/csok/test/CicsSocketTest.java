...
public class CicsSocketTest extends TestCase {
	...
	public void testConnectSend2Parts() throws UnsupportedEncodingException {
		try {
			...
			map.put(Constants.CICS_DATALEN_KEY, "6");
			List <LegStarMessagePart> inputParts = new ArrayList <LegStarMessagePart>();
			LegStarMessagePart inCommarea = new CommareaPart(Util.toByteArray("F3F4F5"));
			inputParts.add(inCommarea);
			LegStarMessagePart inCommarea2 = new CommareaPart(Util.toByteArray("F0F0F0F1F0F0"));
	...
	public void testTooManyCommareaparts() throws UnsupportedEncodingException {
		try {
			...
			map.put(Constants.CICS_TRANSID_KEY, "MIRO");
			List <LegStarMessagePart> inputParts = new ArrayList <LegStarMessagePart>();
			LegStarMessagePart inCommarea1 = new CommareaPart(null);
			inputParts.add(inCommarea1);
			LegStarMessagePart inCommarea2 = new CommareaPart(null);
			inputParts.add(inCommarea2);
			LegStarHeaderPart dp = new LegStarHeaderPart(map, inputParts.size());
			LegStarAddress address = new LegStarAddress("TheMainframe");
			LegStarMessage requestMessage = new LegStarMessage(dp, inputParts);
	...
	public void testNoReallocateContent() throws UnsupportedEncodingException {
		try {
			...
			List <LegStarMessagePart> inputParts = new ArrayList <LegStarMessagePart>();
			LegStarMessagePart inCommarea1 = new CommareaPart(Util.toByteArray("f0f0f0f1f0f0e24b40c44b40c2d6d9d4c1d54040404040404040e2e4d9d9c5e86b40c5d5c7d3c1d5c44040404040f3f2f1f5f6f7f7f8f2f640f1f140f8f15bf0f1f0f04bf1f15c5c5c5c5c5c5c5c5c"));
			inputParts.add(inCommarea1);
			LegStarHeaderPart dp = new LegStarHeaderPart(map, inputParts.size());
			LegStarAddress address = new LegStarAddress("TheMainframe");
			LegStarMessage requestMessage = new LegStarMessage(dp, inputParts);
	...
	public void DoesNotWorktestAsraAbend() throws UnsupportedEncodingException {
		try {
			...
			List <LegStarMessagePart> inputParts = new ArrayList <LegStarMessagePart>();
			LegStarMessagePart inCommarea = new CommareaPart(Util.toByteArray("C1E2D9C1"));
			inputParts.add(inCommarea);
			LegStarHeaderPart dp = new LegStarHeaderPart(map, inputParts.size());
			LegStarAddress address = new LegStarAddress("TheMainframe");
			LegStarMessage requestMessage = new LegStarMessage(dp, inputParts);
