 ...
 *  Ardo02RecordXmlToHostTransformer transformer = new Ardo02RecordXmlToHostTransformer();
 *  byte[] hostByteArray = transformer.transform(new StreamSource(reader));
 * </pre>
 *
 */
public class Ardo02RecordXmlToHostTransformer extends AbstractXmlToHostTransformer {
     ...
     */
    public Ardo02RecordXmlToHostTransformer() throws HostTransformException {
     ...
     * @throws HostTransformException if transformer cannot be created
     */
    public Ardo02RecordXmlToHostTransformer(
