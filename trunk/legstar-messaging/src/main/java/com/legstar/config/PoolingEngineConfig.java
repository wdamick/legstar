...
public class PoolingEngineConfig {
     ...
     * When this number is reached, the engine will stop accepting requests.
     * If the host system is unresponsive it is not useful to continue to accept requests.
     */
    ...
    /**
     * @param managerJNDILocation the work manager can be recovered from JNDI to set
     */
