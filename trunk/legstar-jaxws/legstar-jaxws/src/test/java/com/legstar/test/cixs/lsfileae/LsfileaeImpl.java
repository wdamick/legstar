...
@WebService(endpointInterface = "com.legstar.test.cixs.lsfileae.Lsfileae",
            ...
            portName = "lsfileaePort",
            targetNamespace = "http://cixs.test.legstar.com/lsfileae")
public class LsfileaeImpl extends AbstractServiceAdapter implements Lsfileae {

    /** Name of this service adapter implementation. */
    private static final String  SERVICE_ADAPTER_NAME = "lsfileae";
     ...
     */
    public String getRequestID(final LsfileaeHostHeader hostHeader) {
