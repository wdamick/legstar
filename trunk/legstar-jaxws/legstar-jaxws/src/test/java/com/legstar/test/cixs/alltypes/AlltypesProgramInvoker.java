...
import com.legstar.test.coxb.alltypes.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program ALLTYPES.
 * <p/>
 * This host program maps to operation alltypes.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class AlltypesProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for alltypes. */
    private static final String  OPERATION_NAME = "alltypes";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public AlltypesProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new AlltypesHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the ALLTYPES host program.
     * <p/>
