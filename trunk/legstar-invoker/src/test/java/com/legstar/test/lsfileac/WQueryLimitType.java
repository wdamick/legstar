...
public class WQueryLimitType {
    ...
    @CobolElement(cobolName = "W-MAX-ITEMS-READ", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 5, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 8)
    protected long wMaxItemsRead;
    @XmlElement(name = "WMaxElapseTime")
    @CobolElement(cobolName = "W-MAX-ELAPSE-TIME", type = CobolType.PACKED_DECIMAL_ITEM, byteLength = 5, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 8)
