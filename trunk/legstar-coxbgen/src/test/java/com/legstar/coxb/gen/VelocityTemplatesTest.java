...
public class VelocityTemplatesTest extends AbstractTestTemplate {
    ...
    public void testGenAllTypes() throws Exception {
        ...
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayStringBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolBinaryBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayBinaryBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolPackedDecimalBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayPackedDecimalBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolOctetStreamBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolFloatBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayFloatBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolDoubleBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayDoubleBinding;"));
        ...
        assertTrue(resStr
                .contains("sString.setObjectValue(mValueObject.getSString());"));
        assertTrue(resStr
                .contains("sUshort.setObjectValue(mValueObject.getSUshort());"));
        assertTrue(resStr
                .contains("aDec.setObjectValue(mValueObject.getADec());"));
        assertTrue(resStr
                .contains("aFloat.setObjectValue(mValueObject.getAFloat());"));
        assertTrue(resStr
                .contains("aDouble.setObjectValue(mValueObject.getADouble());"));

        assertTrue(resStr
                .contains("mValueObject.setSString((String) bindingValue);"));
        assertTrue(resStr
                .contains("List < Double > listADouble = cast(bindingValue);"));
        assertTrue(resStr.contains("mValueObject.getADouble().clear();"));
        assertTrue(resStr
                .contains("mValueObject.getADouble().addAll(listADouble);"));
    }
    ...
    public void testGenArrayssm() throws Exception {
        ...
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayComplexBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayStringBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.arrayssm.TableComplex;"));

        assertTrue(resStr
                .contains("public ICobolArrayStringBinding _tableSimple;"));
        assertTrue(resStr
                .contains("public ICobolArrayComplexBinding _tableComplexWrapper;"));
        assertTrue(resStr
                .contains("public ICobolComplexBinding _tableComplexWrapperItem;"));
        assertTrue(resStr
                .contains("public ICobolComplexBinding _tableComplex2;"));
        assertTrue(resStr
                .contains("public ICobolArrayZonedDecimalBinding _tableSimpleNumeric;"));

        assertTrue(resStr
                .contains("tableSimple = BF.createArrayStringBinding(\"TableSimple\","));
        assertTrue(resStr.contains("tableSimple.setByteLength(6);"));
        assertTrue(resStr.contains("tableSimple.setItemByteLength(3);"));
        assertTrue(resStr
                .contains("tableSimple.setCobolName(\"TABLE-SIMPLE\");"));
        ...
        assertTrue(resStr
                .contains("List < TableComplex > listTableComplexWrapper = cast(bindingValue);"));
        assertTrue(resStr.contains("mValueObject.getTableComplex().clear();"));
        assertTrue(resStr
                .contains("mValueObject.getTableComplex().addAll(listTableComplexWrapper);"));
    ...
    public void testGenArrayssmWrapper() throws Exception {
        ...
        assertTrue(resStr
                .contains("private List < TableComplex > mValueObject;"));
        assertTrue(resStr
                .contains("super(bindingName, fieldName, TableComplex.class, null,"
                        + " parentBinding, complexItemBinding);"));
        assertTrue(resStr.contains("setMinOccurs(3);"));
        assertTrue(resStr.contains("setMaxOccurs(3);"));
        assertTrue(resStr
                .contains("mValueObject = new ArrayList < TableComplex >();"));
        assertTrue(resStr
                .contains("mValueObject.add((TableComplex) getComplexItemBinding()."));
        assertTrue(resStr.contains("getObjectValue(TableComplex.class));"));

        assertTrue(resStr
                .contains("public List < TableComplex > getTableComplex() throws HostException {"));
        assertTrue(resStr
                .contains("return (List < TableComplex >) getObjectValue(TableComplex.class);"));
    }
    ...
    public void testGenArraysdo() throws Exception {
        ...
        com.legstar.test.coxb.arraysdo.ObjectFactory objectFactory = new com.legstar.test.coxb.arraysdo.ObjectFactory();

        CComplexReflectBinding ce = new CComplexReflectBinding(
                objectFactory,
                ClassUtil
                        .loadClass("com.legstar.test.coxb.arraysdo.Dfhcommarea"));
        ...
        assertTrue(resStr
                .contains("public ICobolZonedDecimalBinding _tableSize;"));
        assertTrue(resStr
                .contains("public ICobolArrayStringBinding _tableOdo;"));

        assertTrue(resStr
                .contains("tableSize = BF.createZonedDecimalBinding(\"TableSize\","));
        ...
        assertTrue(resStr
                .contains("tableSize.setObjectValue(mValueObject.getTableSize());"));
        assertTrue(resStr
                .contains("setCounterValue(_tableOdo.getDependingOn(),"));
        assertTrue(resStr
                .contains("((List < ? >) mValueObject.getTableOdo()).size());"));

        assertTrue(resStr
                .contains("mValueObject.setTableSize((Integer) bindingValue);"));
        assertTrue(resStr
                .contains("List < String > listTableOdo = cast(bindingValue);"));
        assertTrue(resStr.contains("mValueObject.getTableOdo().clear();"));
        assertTrue(resStr
                .contains("mValueObject.getTableOdo().addAll(listTableOdo);"));
    }
    ...
    public void testGenRedsimpt() throws Exception {
        ...
        String resStr = getSource(GEN_SRC_DIR, "/test.txt");
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolChoiceBinding;"));
        assertTrue(resStr
                .contains("public ICobolChoiceBinding _cDefinition1Choice;"));
        assertTrue(resStr
                .contains("cDefinition1Choice = new CDefinition1ChoiceBinding("
                        + "\"CDefinition1Choice\", this);"));
        assertTrue(resStr
                .contains("cDefinition1Choice.setCobolName(\"C-DEFINITION-1\");"));
    ...
    public void testGenRedsimptChoice() throws Exception {
        ...
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolComplexBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.common.CChoiceBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolZonedDecimalBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolStringBinding;"));
        assertTrue(resStr.contains("public ICobolStringBinding _cDefinition1;"));
        assertTrue(resStr
                .contains("public ICobolZonedDecimalBinding _cDefinition2;"));
        ...
        assertTrue(resStr
                .contains("\"com.legstar.coxb.cust.redsimpt.ChoiceSelector\");"));
        assertTrue(resStr
                .contains("cDefinition1 = BF.createStringBinding(\"CDefinition1\","));
        assertTrue(resStr
                .contains("\"CDefinition1\", String.class, getParentBinding());"));
        assertTrue(resStr
                .contains("cDefinition1.setCobolName(\"C-DEFINITION-1\");"));
        assertTrue(resStr.contains("cDefinition1.setByteLength(18);"));
        assertTrue(resStr
                .contains("cDefinition1.setUnmarshalChoiceStrategyClassName("));
        assertTrue(resStr
                .contains("\"com.legstar.coxb.cust.redsimpt.ChoiceSelector\");"));
        assertTrue(resStr
                .contains("cDefinition2 = BF.createZonedDecimalBinding(\"CDefinition2\","));
        assertTrue(resStr
                .contains("\"CDefinition2\", Long.class, getParentBinding());"));
        assertTrue(resStr
                .contains("cDefinition2.setCobolName(\"C-DEFINITION-2\");"));
        assertTrue(resStr.contains("cDefinition2.setByteLength(18);"));
        assertTrue(resStr.contains("cDefinition2.setTotalDigits(18);"));
        assertTrue(resStr
                .contains("cDefinition2.setRedefines(\"C-DEFINITION-1\");"));
        assertTrue(resStr.contains("addAlternative(_cDefinition1);"));
        assertTrue(resStr.contains("addAlternative(_cDefinition2);"));

        assertTrue(resStr
                .contains("value = getDfhcommarea().getCDefinition1();"));
        assertTrue(resStr.contains("cDefinition1.setObjectValue(value);"));
        assertTrue(resStr
                .contains("value = getDfhcommarea().getCDefinition2();"));
        ...
        assertTrue(resStr
                .contains("public Dfhcommarea getDfhcommarea() throws HostException {"));
        assertTrue(resStr
                .contains("return ((DfhcommareaBinding) getParentBinding()).getDfhcommarea();"));
        assertTrue(resStr
                .contains("return (Dfhcommarea) getParentValueObject();"));
    }
    ...
    public void testGenRedsimptChoiceStrategy() throws Exception {
        ...
        assertTrue(resStr
                .contains("return choice.getAlternativeByName(\"CDefinition2\");"));
    }
    ...
    public void testGenJvmQueryReply() throws Exception {
        ...
        CComplexReflectBinding ce = new CComplexReflectBinding(
                objectFactory,
                ClassUtil
                        .loadClass("com.legstar.test.coxb.jvmquery.JvmQueryReply"));
        ...
        assertTrue(resStr
                .contains("import com.legstar.coxb.common.CComplexBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolBinaryBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.CobolBindingFactory;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolBindingFactory;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolStringBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayStringBinding;"));
        ...
        assertTrue(resStr
                .contains("import com.legstar.xsdc.test.cases.jvmquery.JVMQueryReply;"));
        ...
        assertTrue(resStr
                .contains("public ICobolBinaryBinding _envVarValuesCounter;"));
        assertTrue(resStr.contains("public ICobolStringBinding _country;"));
        assertTrue(resStr
                .contains("public ICobolStringBinding _currencySymbol;"));
        assertTrue(resStr
                .contains("public ICobolArrayStringBinding _envVarValues;"));
        assertTrue(resStr
                .contains("public ICobolStringBinding _formattedDate;"));
        ...
        assertTrue(resStr
                .contains("super(bindingName, fieldName, JVMQueryReply.class, null, parentBinding);"));

        assertTrue(resStr.contains("mValueObject = new JVMQueryReply();"));
        assertTrue(resStr.contains("if (type.equals(JVMQueryReply.class)) {"));
        assertTrue(resStr
                .contains("if (bindingValue.getClass().equals(JVMQueryReply.class)) {"));
        assertTrue(resStr
                .contains("mValueObject = (JVMQueryReply) bindingValue;"));
    ...
    public void testGenHostToJavaTransformer() throws Exception {
        ...
        assertTrue(resStr
                .contains("public class DfhcommareaHostToJavaTransformer extends"
    ...
    public void testVarar021Types() throws Exception {
        ...
        String resStr = getSource(GEN_SRC_DIR, "/test.txt");
        assertTrue(resStr
                .contains("package com.legstar.test.coxb.varar021.bind;"));
        assertTrue(resStr.contains("import com.legstar.coxb.ICobolBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.common.CComplexBinding;"));
        assertTrue(resStr
        ...
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolComplexBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.varar021.IStaticData;"));
        assertTrue(resStr.contains("import java.util.List;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.ICobolArrayComplexBinding;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.varar021.ODynamicData;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.varar021.WellpointEaiEbsErrorRow;"));
        assertTrue(resStr
                .contains("import com.legstar.coxb.host.HostException;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.varar021.Payload;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.varar021.ObjectFactory;"));

        assertTrue(resStr
                .contains("public ICobolZonedDecimalBinding _wechRequestRows;"));
        assertTrue(resStr
                .contains("public ICobolZonedDecimalBinding _wechDynamicResponseRows;"));
        assertTrue(resStr
                .contains("public ICobolZonedDecimalBinding _wechErrorRows;"));
        assertTrue(resStr
                .contains("public ICobolStringBinding _wechAdditionalPageKeys;"));
        assertTrue(resStr.contains("public ICobolComplexBinding _iStaticData;"));
        assertTrue(resStr
                .contains("public ICobolArrayComplexBinding _oDynamicDataWrapper;"));
        assertTrue(resStr
                .contains("public ICobolComplexBinding _oDynamicDataWrapperItem;"));
        assertTrue(resStr
                .contains("public ICobolArrayComplexBinding _wellpointEaiEbsErrorRowWrapper;"));
        assertTrue(resStr
                .contains("public ICobolComplexBinding _wellpointEaiEbsErrorRowWrapperItem;"));
        assertTrue(resStr
                .contains("_iStaticData = new IStaticDataBinding(\"IStaticData\","));
        assertTrue(resStr.contains("\"IStaticData\", this, null);"));
        assertTrue(resStr
                .contains("_iStaticData.setCobolName(\"I-STATIC-DATA\");"));
        assertTrue(resStr.contains("_iStaticData.setMaxOccurs(1);"));
        assertTrue(resStr
                .contains("_iStaticData.setDependingOn(\"WECH-REQUEST-ROWS\");"));
        assertTrue(resStr
                .contains("_oDynamicDataWrapper.setCobolName(\"O-DYNAMIC-DATA\");"));
        assertTrue(resStr.contains("_oDynamicDataWrapper.setMaxOccurs(363);"));
        assertTrue(resStr
                .contains("_oDynamicDataWrapper.setDependingOn(\"WECH-DYNAMIC-RESPONSE-ROWS\");"));

        assertTrue(resStr.contains("getChildrenList().add(_iStaticData);"));
        assertTrue(resStr
                .contains("getChildrenList().add(_oDynamicDataWrapper);"));
        assertTrue(resStr
                .contains("_iStaticData.setObjectValue(mValueObject.getIStaticData());"));
        assertTrue(resStr
                .contains("if (null != mValueObject.getIStaticData()) {"));
        assertTrue(resStr
                .contains("setCounterValue(_iStaticData.getDependingOn(), 1);"));
        assertTrue(resStr
                .contains(" _oDynamicDataWrapper.setObjectValue(mValueObject.getODynamicData());"));
    }
    ...
    public void testGenTransformers() throws Exception {
        ...
        assertTrue(resStr
                .contains("public Dfhcommarea toJava(final byte[] hostData, final String hostCharset,"));
        assertTrue(resStr
                .contains("public Dfhcommarea toJava(final byte[] hostData,"));
        assertTrue(resStr
                .contains("public Dfhcommarea toJava(final byte[] hostData, final String hostCharset)"));
        assertTrue(resStr
                .contains("public Dfhcommarea toJava(final byte[] hostData)"));
    ...
    public void testGenJvmqueryTransformers() throws Exception {
        ...
        String resStr = getSource(GEN_SRC_DIR, "/test.txt");
        assertTrue(resStr
                .contains("package com.legstar.test.coxb.jvmquery.bind;"));
        assertTrue(resStr
                .contains("import com.legstar.xsdc.test.cases.jvmquery.JVMQueryReply;"));
        assertTrue(resStr
        ...
        assertTrue(resStr
                .contains("new JvmQueryReplyHostToJavaTransformer());"));
        assertTrue(resStr
                .contains("public JVMQueryReply toJava(final byte[] hostData, final String hostCharset,"));
        assertTrue(resStr
                .contains("public JVMQueryReply toJava(final byte[] hostData,"));
        assertTrue(resStr
                .contains("public JVMQueryReply toJava(final byte[] hostData, final String hostCharset)"));
        assertTrue(resStr
                .contains("public JVMQueryReply toJava(final byte[] hostData)"));
    ...
    public void testHostToXmlTransformer() {
        try {
            ...
            assertTrue(resStr
                    .contains("super(new DfhcommareaHostToJavaTransformer());"));
            assertTrue(resStr
                    .contains("public DfhcommareaHostToXmlTransformer("));
            assertTrue(resStr
                    .contains("final CobolContext cobolContext) throws HostTransformException {"));
            assertTrue(resStr
                    .contains("super(new DfhcommareaHostToJavaTransformer(cobolContext));"));
            assertTrue(resStr
                    .contains("final String hostCharset) throws HostTransformException {"));
            assertTrue(resStr
                    .contains("super(new DfhcommareaHostToJavaTransformer(hostCharset));"));
            assertTrue(resStr.contains("return \"Dfhcommarea\";"));
            assertTrue(resStr
                    .contains("return \"http://legstar.com/test/coxb/alltypes\";"));
    ...
    public void testXmlToHostTransformer() {
        try {
            ...
            assertTrue(resStr
                    .contains("super(new DfhcommareaJavaToHostTransformer());"));
            assertTrue(resStr
                    .contains("public DfhcommareaXmlToHostTransformer("));
            assertTrue(resStr
                    .contains("final CobolContext cobolContext) throws HostTransformException {"));
            assertTrue(resStr
                    .contains("super(new DfhcommareaJavaToHostTransformer(cobolContext));"));
            assertTrue(resStr
                    .contains("final String hostCharset) throws HostTransformException {"));
            assertTrue(resStr
                    .contains("super(new DfhcommareaJavaToHostTransformer(hostCharset));"));
        } catch (ReflectBindingException e) {
            fail(e.getMessage());
        } catch (ClassNotFoundException e) {
            fail(e.getMessage());
    ...
    public void testXmlTransformers() {
        try {
            ...
            assertTrue(resStr
                    .contains("super(new DfhcommareaXmlToHostTransformer(),"));
            assertTrue(resStr
                    .contains("new DfhcommareaHostToXmlTransformer());"));
        } catch (ReflectBindingException e) {
            fail(e.getMessage());
        } catch (ClassNotFoundException e) {
            fail(e.getMessage());
