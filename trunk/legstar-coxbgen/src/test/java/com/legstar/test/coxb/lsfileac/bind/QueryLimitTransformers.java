...
/**
 * Transformer provider for QueryLimit java data object.
 *
 */
public class QueryLimitTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public QueryLimitTransformers() {
        super(new QueryLimitJavaToHostTransformer(),
                new QueryLimitHostToJavaTransformer());
    }
     ...
     */
    public QueryLimit toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryLimit toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public QueryLimit toJava(final byte[] hostData, final int offset,
