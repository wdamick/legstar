...
public class DfhcommareaTypeBinding 
    ...
    /** Child property LsSignedNativeTypeBinding of complex type. */
    public LsSignedNativeTypeBinding lsSignedNative;
    ...
    public final void initChildren() {
        ...
        lsSignedNative = new LsSignedNativeTypeBinding(this);
        
        /* Add children to children list */
           
        getChildrenList().add(lsUnsignedNative);
        getChildrenList().add(lsSignedNative);
    }
    ...
    public final void prepareChildren() throws HostException {
        ...
        /* Pass on the JAXB factory to child lsSignedNative  */
        lsSignedNative.setObjectFactory(mObjectFactory);
    ...
    public final void getValuesFromBoundObject() throws HostException {
        ...
        if (mJaxbObject.getLsSignedNative() != null) {
            /* Set value from lsSignedNative*/
            lsSignedNative.setJaxbObject(mJaxbObject.getLsSignedNative());
            
        } else {
            lsSignedNative.setJaxbObject(mObjectFactory.createLsSignedNativeType());
        }
    ...
    public final void setBoundObjectValue(final int index) throws HostException {
        ...
        case 0:
            ...
            break;
        case 1:
            setBoundObjectValueLsSignedNative();
            break;
        }
    }
    ...
    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueLsSignedNative() throws HostException {
    
        /* Set value of complex child lsSignedNative*/
        mJaxbObject.setLsSignedNative(lsSignedNative.getJaxbObject());
