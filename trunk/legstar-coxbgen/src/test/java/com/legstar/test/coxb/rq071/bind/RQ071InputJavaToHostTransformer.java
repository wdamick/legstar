...
/**
 * Transforms a RQ071Input data object to mainframe data.
 * <p/>
 * This is a typical use of this class:
 * <pre>
 *  RQ071InputJavaToHostTransformer transformer = new RQ071InputJavaToHostTransformer();
 *  byte[] hostByteArray = transformer.transform(javaValue);
 * </pre>
 *
 */
public class RQ071InputJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public RQ071InputJavaToHostTransformer() {
        super();
    }
     ...
     */
    public RQ071InputJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public RQ071InputJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
