...
public class DfhcommareaTypeBinding 
    ...
    /** Child bound to jaxb property null(null). */
    public ICobolBinaryBinding listOdoCounter;
    /** Child bound to jaxb property ListOdo(String). */
    public ICobolArrayStringBinding listOdo;
    ...
    private void initChildren() {
        ...
        listOdoCounter = BF.createBinaryBinding("ListOdoCounter", this);
        listOdoCounter.setByteLength(4);
        listOdoCounter.setCobolName("LIST-ODO--C");
        listOdoCounter.setTotalDigits(9);
        listOdoCounter.setIsODOObject(true);
        listOdo = BF.createArrayStringBinding("ListOdo", 
               "ListOdo", String.class, this);
        listOdo.setByteLength(5);
        listOdo.setCobolName("LIST-ODO");
        listOdo.setMinOccurs(1);
        listOdo.setMaxOccurs(100);
        listOdo.setDependingOn("LIST-ODO--C");
        
        /* Add children to children list */
        getChildrenList().add(listOdoCounter);
        getChildrenList().add(listOdo);
    ...
    public final void setChildrenValues() throws HostException {
        ...
        /* Get JAXB property ListOdo */
        if (LOG.isDebugEnabled()) {
            LOG.debug("Getting value from JAXB property "
                    + "ListOdo"
                    + " value=" + mJaxbObject.getListOdo());
        }
        listOdo.setObjectValue(mJaxbObject.getListOdo());
        
        /* For variable size array or list, we make sure any
         * associated counter is updated */
        setCounterValue(listOdo.getDependingOn(),
                ((List) mJaxbObject.getListOdo()).size());
    ...
    public final void setJaxbPropertyValue(final int index) throws HostException {
        ...
        case 0:
            break;
        case 1:
            mJaxbObject.getListOdo().clear();
            mJaxbObject.getListOdo().addAll(
                (List < String >) value);
            break;
        default:
            break;
