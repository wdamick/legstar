...
public class LsReplyDataTypeBinding 
    ...
    /** Child bound to jaxb property LsItemsCount(Long). */
    public ICobolBinaryBinding lsItemsCount;
    /** Child bound to jaxb property LsItemsArray(LsItemsArrayType). */
    public LsItemsArrayTypeWrapperBinding lsItemsArrayWrapper;
    /** Binding item for complex array binding LsItemsArrayTypeWrapperBinding. */
    public LsItemsArrayTypeBinding lsItemsArrayWrapperItem;
            
    /** Logger. */
    private static final Log LOG
        = LogFactory.getLog(LsReplyDataTypeBinding.class);
    ...
    public LsReplyDataTypeBinding(
        ...
        super(name, jaxbName, LsReplyDataType.class, null, parentBinding);
    ...
    private void initChildren() {
        ...
        lsItemsCount = BF.createBinaryBinding("LsItemsCount", 
               "LsItemsCount", Long.class, this);
        lsItemsCount.setByteLength(4);
        lsItemsCount.setCobolName("LS-ITEMS-COUNT");
        lsItemsCount.setTotalDigits(9);
        lsItemsCount.setIsODOObject(true);
        lsItemsArrayWrapperItem = new LsItemsArrayTypeBinding("LsItemsArrayWrapperItem",
             "LsItemsArray", this, null);
        lsItemsArrayWrapper = new LsItemsArrayTypeWrapperBinding("LsItemsArrayWrapper",
             "LsItemsArray", this, lsItemsArrayWrapperItem);
        
        /* Add children to children list */
        getChildrenList().add(lsItemsCount);
        getChildrenList().add(lsItemsArrayWrapper);
    ...
    public final void createJaxbObject() throws HostException {
        ...
        mJaxbObject = mJaxbObjectFactory.createLsReplyDataType();
    }
    ...
    public final void setChildrenValues() throws HostException {
        ...
        /* Get JAXB property LsItemsCount */
        if (LOG.isDebugEnabled()) {
            LOG.debug("Getting value from JAXB property "
                    + "LsItemsCount"
                    + " value=" + mJaxbObject.getLsItemsCount());
        }
        lsItemsCount.setObjectValue(mJaxbObject.getLsItemsCount());
        
        /* Get JAXB property LsItemsArray */
        if (LOG.isDebugEnabled()) {
            LOG.debug("Getting value from JAXB property "
                    + "LsItemsArray"
                    + " value=" + mJaxbObject.getLsItemsArray());
        }
        lsItemsArrayWrapper.setObjectValue(mJaxbObject.getLsItemsArray());
    ...
    public final void setJaxbPropertyValue(final int index) throws HostException {
        ...
        switch (index) {
        case 0:
            mJaxbObject.setLsItemsCount((Long) value);
            break;
        case 1:
            mJaxbObject.getLsItemsArray().clear();
            mJaxbObject.getLsItemsArray().addAll(
                (List < LsItemsArrayType >) value);
            break;
        default:
            break;
        }
    ...
    public final Object getObjectValue(final Class type) throws HostException {
        if (type.equals(LsReplyDataType.class)) {
            return mJaxbObject;
        } else {
    ...
    public final void setObjectValue(final Object value) throws HostException {
        ...
        if (value.getClass().equals(LsReplyDataType.class)) {
            mJaxbObject = (LsReplyDataType) value;
        } else {
     ...
     */
    public final LsReplyDataType getLsReplyDataType() {
        return mJaxbObject;
    }
