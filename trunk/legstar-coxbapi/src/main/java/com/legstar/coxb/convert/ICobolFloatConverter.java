 ...
 * 
 */
public interface ICobolFloatConverter {
	/**
	 ...
	 */
	int toHost(ICobolFloatBinding ce, byte[] hostTarget, int offset)
	 ...
	 * @throws HostException if conversion fails
	 */
	int toHost(ICobolArrayFloatBinding ce, byte[] hostTarget, int offset,
			int currentOccurs)
		throws HostException;
	 ...
	 * @throws HostException if conversion fails
	 */
	int fromHost(ICobolFloatBinding ce, byte[] hostSource, int offset)
		throws HostException;
	 ...
	 * @throws HostException if conversion fails
	 */
	int fromHost(ICobolArrayFloatBinding ce, byte[] hostSource, int offset,
			int currentOccurs)
		throws HostException;
}
