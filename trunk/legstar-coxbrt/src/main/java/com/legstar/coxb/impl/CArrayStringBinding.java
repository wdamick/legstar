 ...
 * 
*/
public class CArrayStringBinding extends CBinding
	...
	/**
	 * Creates an empty binding between a Cobol array of string elements
	...
	/**
	 * Creates a binding between a Cobol array of string elements and a
