 ...
 * 
*/
public class CArrayBinaryBinding extends CArrayNumericBinding
	implements ICobolArrayBinaryBinding {
	
	/**
	 * Creates an empty binding between a Cobol array of binary numeric 
	 * elements and a java List of BigDecimals.
	 * 
	...
	/**
	 * Creates a binding between a Cobol array of binary numeric elements
