 ...
 * 
*/
public abstract class CArrayNumericBinding extends CBinding
	...
	/**
	 * Creates an empty binding between a Cobol array of numeric elements
	...
	/**
	 * Creates a binding between a Cobol array of numeric elements and a
