...
public class MeteringTest extends TestCase {
    ...
    private static final byte[] STRING_HOST_BYTES =
        HostData.toByteArray(
    ...
    private static final byte[] PACKED_DECIMAL_HOST_BYTES =
        HostData.toByteArray("12345678901234512d");

    /** The zoned decimal encoding of a decimal.*/
    private static final byte[] ZONED_DECIMAL_HOST_BYTES =
        HostData.toByteArray("f1f2f3f4f5f6f7f8f9f0f1f2f3f4f5f1d2");

    /** The BigDecimal equivalent to the COBOL decimal.*/
    private static final BigDecimal DECIMAL_JAVA =
        new BigDecimal("-123456789012345.12");
    
    /** The BINARY encoding of an integer.*/
    private static final byte[] BINARY_HOST_BYTES =
        HostData.toByteArray("80000000");

    /** The BigDecimal equivalent to the COBOL integer.*/
    private static final BigDecimal INTEGER_JAVA =
    ...
    public void testAlphanumericToString() {
        try {
            String javaString = CobolStringSimpleConverter.fromHostSingle(
                    STRING_FRENCH_CHARSET, STRING_HOST_BYTES.length, STRING_HOST_BYTES, 0);
    ...
    public void testPackedDecimalToBigDecimal() {
        try {
            BigDecimal javaDecimal = CobolPackedDecimalSimpleConverter.fromHostSingle(
                    9, 17, 2, PACKED_DECIMAL_HOST_BYTES, 0);
    ...
    public void testZonedDecimalToBigDecimal() {
        try {
            BigDecimal javaDecimal = CobolZonedDecimalSimpleConverter.fromHostSingle(
                    17, 17, 2, true, false, false, ZONED_DECIMAL_HOST_BYTES, 0, STRING_FRENCH_CHARSET);
            assertEquals(0, javaDecimal.compareTo(DECIMAL_JAVA));
        } catch (CobolConversionException e) {
            fail(e.getMessage());
        }
    ...
    public void testStringToAlphanumeric() {
        try {
            ...
            CobolStringSimpleConverter.toHostSingle(
                    STRING_JAVA, STRING_FRENCH_CHARSET, STRING_HOST_BYTES.length, false, hostBytes, 0);
    ...
    public void testBigDecimalToPackedDecimal() {
        try {
            ...
            CobolPackedDecimalSimpleConverter.toHostSingle(
                    DECIMAL_JAVA, PACKED_DECIMAL_HOST_BYTES.length, 17, 2, true, hostBytes, 0);
            assertEquals(PACKED_DECIMAL_HOST_BYTES[0], hostBytes[0]);
            assertEquals(PACKED_DECIMAL_HOST_BYTES[PACKED_DECIMAL_HOST_BYTES.length - 1],
    ...
    public void testBigDecimalToBinary() {
        try {
            ...
            CobolBinarySimpleConverter.toHostSingle(
                    INTEGER_JAVA, BINARY_HOST_BYTES.length, true, hostBytes, 0);
