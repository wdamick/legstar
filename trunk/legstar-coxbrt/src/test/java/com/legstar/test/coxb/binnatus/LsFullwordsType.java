...
public class LsFullwordsType {
    ...
    @CobolElement(cobolName = "LS-P9X9-LOW", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
    protected long lsP9X9Low;
    @XmlElement(name = "LsP9X9High")
    @CobolElement(cobolName = "LS-P9X9-HIGH", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 4, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 9)
