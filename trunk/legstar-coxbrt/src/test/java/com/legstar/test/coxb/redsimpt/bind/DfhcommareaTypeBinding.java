...
public class DfhcommareaTypeBinding 
    ...
    /** Child property CDefinition1ChoiceBinding of choice type. */
    public CDefinition1ChoiceBinding cDefinition1;
    ...
    public final void initChildren() {
        ...
        cDefinition1 = new CDefinition1ChoiceBinding(this);
        
        /* Add children to children list */
           
        getChildrenList().add(cDefinition1);
    }
    ...
    public final void prepareChildren() throws HostException {
        ...
        /* Child cDefinition1 is a choice. Because JAXB does not create
         * objects for choices, we propagate the parent object. */
        cDefinition1.setJaxbObject(mJaxbObject);
        cDefinition1.setObjectFactory(mObjectFactory);
