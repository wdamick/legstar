...
public class LsHalfwordsType {
    ...
    @CobolElement(cobolName = "LS-PS9X4-LOW", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 2, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 4)
    protected short lsPs9X4Low;
    @XmlElement(name = "LsPs9X4High")
    @CobolElement(cobolName = "LS-PS9X4-HIGH", type = CobolType.NATIVE_BINARY_ITEM, byteLength = 2, isJustifiedRight = false, isSigned = true, isSignLeading = false, isSignSeparate = false, totalDigits = 4)
