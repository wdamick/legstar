...
public class CParaoutType {
    ...
    @CobolElement(cobolName = "C-SOME-OUTPUT", type = CobolType.ZONED_DECIMAL_ITEM, byteLength = 8, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false, totalDigits = 8)
    protected long cSomeOutput;
    @XmlElement(name = "Filler27", required = true)
    @CobolElement(cobolName = "FILLER-27", type = CobolType.ALPHANUMERIC_ITEM, byteLength = 17, isJustifiedRight = false, isSigned = false, isSignLeading = false, isSignSeparate = false)
