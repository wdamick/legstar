...
public class ElementOneTypeBinding 
    ...
    public ElementOneTypeBinding(
        final ObjectFactory objectFactory,
        final ElementOneType jaxbObject) {
    ...
    public final void initChildren() {
        ...
        elementTwo = new ElementTwoTypeWrapperBinding(this);
        
        /* Add children to children list */
           
        getChildrenList().add(elementTwo);
    }
  
   
    /** {@inheritDoc} */
    public final void createBoundObject() throws HostException {
        setJaxbObject(mObjectFactory.createElementOneType());
    }
       
    /** {@inheritDoc} */
    public final void prepareChildren() throws HostException {
    
        /* Pass on the JAXB factory to child elementTwo  */
        elementTwo.setObjectFactory(mObjectFactory);
    ...
    public final void getValuesFromBoundObject() throws HostException {
        ...
        if (mJaxbObject.getElementTwo() != null) {
            /* Set value from elementTwo*/
            elementTwo.setJaxbObject(mJaxbObject.getElementTwo());
            
        } else {
            elementTwo.createBoundObject();
        }
    ...
    public final void setBoundObjectValue(final int index) throws HostException {
        ...
        switch (index) {
        case 0:
            setBoundObjectValueElementTwo();
            break;
        }
    }
            
    /** Set corresponding JAXB object property value. */
    private final void setBoundObjectValueElementTwo() throws HostException {
    
        /* Set value of complex array child elementTwo*/
        mJaxbObject.getElementTwo().clear();
        mJaxbObject.getElementTwo().addAll(elementTwo.getJaxbObject());
     ...
     */
    public final ElementOneType getJaxbObject() {
        return mJaxbObject;
    }
