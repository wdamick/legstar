...
public class DfhcommareaTypeBinding 
    ...
    public CArrayStringBinding cArray;
    ...
    public final void initChildren() {
        ...
        cArray = new CArrayStringBinding("cArray", this, 5, false, 3, 3);
        cArray.setCobolName("C-ARRAY");
    ...
    public final void getValuesFromBoundObject() throws HostException {
        ...
        if (mJaxbObject.getCArray() != null) {
            ...
            cArray.setValue(mJaxbObject.getCArray());
        }
    ...
    private final void setBoundObjectValueCArray() throws HostException {
        ...
        if (cArray.getValue() != null) {
            /* Set value of cArray*/
            mJaxbObject.getCArray().clear();
            mJaxbObject.getCArray().addAll(cArray.getValue());
        }
