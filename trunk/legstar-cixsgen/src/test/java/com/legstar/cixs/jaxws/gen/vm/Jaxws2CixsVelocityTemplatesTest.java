...
public class Jaxws2CixsVelocityTemplatesTest extends AbstractTestTemplate {
    ...
    public void testHostHeader() throws Exception {
        ...
        assertTrue(resStr
                .contains("namespace = \"http://cixs.test.legstar.com/lsfileae\","));
    ...
    public void testHolder() throws Exception {
        ...
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.lsfileac.QueryLimit;"));
        assertTrue(resStr
                .contains("import com.legstar.test.coxb.lsfileac.QueryData;"));
        assertTrue(resStr
                .contains("@XmlType(name = \"LsfileacRequestHolder\","));
        assertTrue(resStr
                .contains("namespace = \"http://cixs.test.legstar.com/lsfileac\","));
        ...
        assertTrue(resStr
                .contains("namespace = \"http://legstar.com/test/coxb/lsfileac\","));
    ...
    public void testWrapper() throws Exception {
        ...
        assertTrue(resStr
                .contains("@XmlRootElement(name = \"LsfileaeRequest\")"));
        ...
        assertTrue(resStr
                .contains("namespace = \"http://legstar.com/test/coxb/lsfileae\","));
    ...
    public void testWrapperWithHolder() throws Exception {
        ...
        assertTrue(resStr.contains("package com.legstar.test.cixs.lsfileac;"));
        assertTrue(resStr
                .contains("@XmlRootElement(name = \"LsfileacRequest\")"));
        ...
        assertTrue(resStr
                .contains("@XmlElement(name = \"LsfileacRequestHolder\","));
        assertTrue(resStr
                .contains("namespace = \"http://cixs.test.legstar.com/lsfileac\","));
        assertTrue(resStr.contains("private LsfileacRequestHolder request;"));
        assertTrue(resStr
                .contains("public LsfileacRequestHolder getRequest() {"));
        assertTrue(resStr.contains("return request;"));
        assertTrue(resStr.contains("public void setRequest("));
    ...
    public void testFault() throws Exception {
        ...
        assertTrue(resStr.contains("final LsfileaeFaultInfo fault,"));
        assertTrue(resStr
                .contains("returns fault bean: com.legstar.test.cixs.lsfileae.LsfileaeFaultInfo"));
    ...
    public void testSunJaxwsXml() throws Exception {
        ...
        assertTrue(resStr
                .contains("implementation=\"com.legstar.test.cixs.lsfileae.LsfileaeImpl\""));
    ...
    public void testWebXml() throws Exception {
        ...
        assertTrue(resStr
                .contains("<description>LegStar Jaxws lsfileae Web Service</description>"));
        assertTrue(resStr
                .contains("<servlet-name>lsfileaeService</servlet-name>"));
    ...
    public void testAntBuildWar() throws Exception {
        ...
        assertTrue(resStr
                .contains("<war warfile=\"/legstar-cixsgen-cases/target/cixs-lsfileae.war\""));
        assertTrue(resStr
                .contains("webxml=\"/Legsem/Legstar/Dev/webapp/WEB-INF/web.xml\">"));
        assertTrue(resStr
                .contains("<webinf dir=\"/Legsem/Legstar/Dev/webapp/WEB-INF\""));
        assertTrue(resStr
                .contains("<lib dir=\"/legstar-cixsgen-cases/target\">"));
    ...
    public void testAntDeploy() throws Exception {
        ...
        assertTrue(resStr
                .contains("<delete file=\"/Servers/TOMDev/webapps/cixs-lsfileae.war\""));
        assertTrue(resStr
                .contains("<copy file=\"/legstar-cixsgen-cases/target/cixs-lsfileae.war\""));
    ...
    public void testPackageInfo() throws Exception {
        ...
        assertTrue(resStr
                .contains("@javax.xml.bind.annotation.XmlSchema(namespace ="
                        + " \"http://cixs.test.legstar.com/lsfileae\","));
        assertTrue(resStr
                .contains("elementFormDefault = javax.xml.bind.annotation.XmlNsForm.QUALIFIED)"));
        assertTrue(resStr.contains("package com.legstar.test.cixs.lsfileae;"));
    }
    ...
    public void testObjectFactory() throws Exception {
        ...
        assertTrue(resStr.contains("package com.legstar.test.cixs.lsfileae;"));
        assertTrue(resStr
                .contains("public LsfileaeRequest createLsfileaeRequest() {"));
        assertTrue(resStr
                .contains("public LsfileaeResponse createLsfileaeResponse() {"));
        assertTrue(resStr
                .contains("public LsfileaeHostHeader createLsfileaeHostHeader() {"));
        assertTrue(resStr
                .contains("public LsfileaeFaultInfo createLsfileaeFaultInfo() {"));
    }
}
