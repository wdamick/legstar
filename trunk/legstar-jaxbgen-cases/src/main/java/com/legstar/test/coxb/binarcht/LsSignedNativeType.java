...
public class LsSignedNativeType {
    ...
    @CobolElement(cobolName = "LS-PS9X4-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 2, isSigned = true, totalDigits = 4, picture = "S9(4)", usage = "COMP-5", srceLine = 49)
    protected short lsPs9X4Min;
    @XmlElement(name = "LsPs9X4Max")
    @CobolElement(cobolName = "LS-PS9X4-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 2, isSigned = true, totalDigits = 4, picture = "S9(4)", usage = "COMP-5", srceLine = 50)
    protected short lsPs9X4Max;
    @XmlElement(name = "LsPs9X9Min")
    @CobolElement(cobolName = "LS-PS9X9-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 4, isSigned = true, totalDigits = 9, picture = "S9(9)", usage = "COMP-5", srceLine = 51)
    protected int lsPs9X9Min;
    @XmlElement(name = "LsPs9X9Max")
    @CobolElement(cobolName = "LS-PS9X9-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 4, isSigned = true, totalDigits = 9, picture = "S9(9)", usage = "COMP-5", srceLine = 52)
    protected int lsPs9X9Max;
    @XmlElement(name = "LsPs9X18Min")
    @CobolElement(cobolName = "LS-PS9X18-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 8, isSigned = true, totalDigits = 18, picture = "S9(18)", usage = "COMP-5", srceLine = 53)
    protected long lsPs9X18Min;
    @XmlElement(name = "LsPs9X18Max")
    @CobolElement(cobolName = "LS-PS9X18-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 10, byteLength = 8, isSigned = true, totalDigits = 18, picture = "S9(18)", usage = "COMP-5", srceLine = 54)
