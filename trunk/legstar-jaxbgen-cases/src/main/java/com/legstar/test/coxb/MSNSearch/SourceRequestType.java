...
public class SourceRequestType {
    ...
    @CobolElement(cobolName = "R-Count", type = CobolType.BINARY_ITEM, levelNumber = 9, byteLength = 4, isSigned = true, totalDigits = 9, picture = "9(9)", usage = "COMP-5")
    protected int count;
    @XmlElement(name = "FileType")
    @CobolElement(cobolName = "FileType", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 9, byteLength = 32, picture = "X(32)", usage = "DISPLAY")
    protected String fileType;
    @XmlList
    @XmlElement(name = "SortBy", defaultValue = "Default")
    @CobolElement(cobolName = "SortBy", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 9, byteLength = 32, minOccurs = 1, maxOccurs = 10, picture = "X(32)", usage = "DISPLAY")
    protected List<String> sortBy;
    @XmlList
    @XmlElement(name = "ResultFields", required = true, defaultValue = "Title Description Url")
    @CobolElement(cobolName = "ResultFields", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 9, byteLength = 32, minOccurs = 1, maxOccurs = 10, picture = "X(32)", usage = "DISPLAY")
