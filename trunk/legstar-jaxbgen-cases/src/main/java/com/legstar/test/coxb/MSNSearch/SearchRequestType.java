...
public class SearchRequestType {
    ...
    @CobolElement(cobolName = "Query", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 128, picture = "X(128)", usage = "DISPLAY")
    protected String query;
    @XmlElement(name = "CultureInfo", required = true)
    @CobolElement(cobolName = "CultureInfo", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 16, picture = "X(16)", usage = "DISPLAY")
    ...
    @CobolElement(cobolName = "Flags", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 32, minOccurs = 1, maxOccurs = 10, picture = "X(32)", usage = "DISPLAY")
