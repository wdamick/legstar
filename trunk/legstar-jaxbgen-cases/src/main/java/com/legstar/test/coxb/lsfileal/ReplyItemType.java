...
public class ReplyItemType {
    ...
    @CobolElement(cobolName = "REPLY-NUMBER", type = CobolType.ZONED_DECIMAL_ITEM, levelNumber = 15, byteLength = 6, isSigned = false, totalDigits = 6, picture = "9(6)", usage = "DISPLAY", srceLine = 69)
    ...
    @CobolElement(cobolName = "REPLY-DATE", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 15, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 74)
    protected String replyDate;
    @XmlElement(name = "ReplyAmount", required = true)
    @CobolElement(cobolName = "REPLY-AMOUNT", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 15, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 75)
    protected String replyAmount;
    @XmlElement(name = "ReplyComment", required = true)
    @CobolElement(cobolName = "REPLY-COMMENT", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 15, byteLength = 9, picture = "X(9)", usage = "DISPLAY", srceLine = 76)
