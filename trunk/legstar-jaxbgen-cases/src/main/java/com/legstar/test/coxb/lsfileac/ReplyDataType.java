 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="ReplyItem" type="{http://legstar.com/test/coxb/lsfileac}ReplyItemType" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReplyDataType {
    ...
    @CobolElement(cobolName = "REPLY-ITEMSCOUNT", type = CobolType.PACKED_DECIMAL_ITEM, levelNumber = 5, byteLength = 5, isSigned = false, totalDigits = 8, isODOObject = true, picture = "9(8)", usage = "PACKED-DECIMAL", srceLine = 64)
    protected long replyItemscount;
    @XmlElement(name = "ReplyItem", required = true)
    @CobolElement(cobolName = "REPLY-ITEM", type = CobolType.GROUP_ITEM, levelNumber = 5, minOccurs = 1, maxOccurs = 100, dependingOn = "REPLY-ITEMSCOUNT", srceLine = 66)
