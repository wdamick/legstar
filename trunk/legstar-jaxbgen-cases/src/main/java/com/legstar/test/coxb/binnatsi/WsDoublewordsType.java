...
public class WsDoublewordsType {
    ...
    @CobolElement(cobolName = "WS-PS9X18-MIN", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = true, totalDigits = 18, redefines = "WS-PS9X18-MIN-B", picture = "S9(18)", usage = "COMP-5", srceLine = 46)
    protected Long wsPs9X18Min;
    @XmlElement(name = "WsPs9X18Low")
    @CobolElement(cobolName = "WS-PS9X18-LOW", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = true, totalDigits = 18, picture = "S9(18)", usage = "COMP-5", srceLine = 47)
    ...
    @CobolElement(cobolName = "WS-PS9X18-HIGH", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = true, totalDigits = 18, redefines = "WS-PS9X18-HIGH-B", picture = "S9(18)", usage = "COMP-5", srceLine = 52)
    ...
    @CobolElement(cobolName = "WS-PS9X18-MAX", type = CobolType.NATIVE_BINARY_ITEM, levelNumber = 15, byteLength = 8, isSigned = true, totalDigits = 18, redefines = "WS-PS9X18-MAX-B", picture = "S9(18)", usage = "COMP-5", srceLine = 57)
