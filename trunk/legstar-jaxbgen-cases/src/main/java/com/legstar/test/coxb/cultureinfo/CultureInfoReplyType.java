 ...
 *         &lt;element name="serverCultureInfo" type="{http://sample.legstar.com/}serverCultureInfo" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CultureInfoReplyType {

    @CobolElement(cobolName = "currencySymbol", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 32, picture = "X(32)", usage = "DISPLAY")
    protected String currencySymbol;
    @CobolElement(cobolName = "displayCountry", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 32, picture = "X(32)", usage = "DISPLAY")
    protected String displayCountry;
    @CobolElement(cobolName = "displayLanguage", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 32, picture = "X(32)", usage = "DISPLAY")
    protected String displayLanguage;
    @CobolElement(cobolName = "formattedDate", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 32, picture = "X(32)", usage = "DISPLAY")
    protected String formattedDate;
    @CobolElement(cobolName = "formattedDecimalNumber", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 5, byteLength = 32, picture = "X(32)", usage = "DISPLAY")
    protected String formattedDecimalNumber;
    @CobolElement(cobolName = "serverCultureInfo", type = CobolType.GROUP_ITEM, levelNumber = 5)
    protected ServerCultureInfoType serverCultureInfo;
     ...
     * @return
     *     possible object is
     *     {@link ServerCultureInfoType }
     *     
     */
    public ServerCultureInfoType getServerCultureInfo() {
     ...
     *     
     */
    public void setServerCultureInfo(ServerCultureInfoType value) {
