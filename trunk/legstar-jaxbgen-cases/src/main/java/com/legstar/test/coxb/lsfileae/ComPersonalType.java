...
public class ComPersonalType {
    ...
    @CobolElement(cobolName = "COM-NAME", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 10, byteLength = 20, picture = "X(20)", usage = "DISPLAY", srceLine = 34)
    protected String comName;
    @XmlElement(name = "ComAddress", required = true)
    @CobolElement(cobolName = "COM-ADDRESS", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 10, byteLength = 20, picture = "X(20)", usage = "DISPLAY", srceLine = 35)
    protected String comAddress;
    @XmlElement(name = "ComPhone", required = true)
    @CobolElement(cobolName = "COM-PHONE", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 10, byteLength = 8, picture = "X(8)", usage = "DISPLAY", srceLine = 36)
