...
public class MarshalCharsetsTest extends TestCase {
	...
	public void testCharsets() throws Exception {
		...
		com.legstar.test.coxb.charsets.bind.DfhcommareaTypeBinding ccem = new com.legstar.test.coxb.charsets.bind.DfhcommareaTypeBinding(objectFactory, dfhcommareaType);
		ccem.accept(mv);
