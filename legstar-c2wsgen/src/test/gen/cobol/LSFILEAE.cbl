      ...
      * c2wsrt C API.                                                 *
      * Program generated by LegStar COBOL CICS Client generator.     *
      * Generated on 2008-06-06 12:12:39                              *
      ...
      *    
       77  C2WS-SERVICE-URI            PIC X(18) VALUE
           'http://192.168.0.2'.
      *    
      ...
      *---------------------------------------------------------------*
       ...
       77  THIS-TRACE-ID               PIC X(13) VALUE 'LSFILEAE'.
