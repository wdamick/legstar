...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
         ...
         * */
        store.setDefault(PreferenceConstants.XSD_NAMESPACE_PREFIX, "http://coxb.test.legstar.com");
        store.setDefault(PreferenceConstants.DEFAULT_XSD_ENCODING, Cob2XsdContext.DEFAULT_XSD_ENCODING);
        store.setDefault(PreferenceConstants.DEFAULT_XSD_MAP_CONDITIONS_TO_FACETS, false);
        store.setDefault(PreferenceConstants.DEFAULT_XSD_CUSTOM_XSLT_FILE_NAME, "");
        store.setDefault(PreferenceConstants.DEFAULT_XSD_NAME_CONFLICT_PREPEND_PARENT_NAME, false);
        store.setDefault(PreferenceConstants.DEFAULT_XSD_ELEMENT_NAMES_START_WITH_UPPERCASE, false);

        /* -------------------------------------------------------------------
         * LegStar annotations default options
         * */
        store.setDefault(PreferenceConstants.DEFAULT_ADD_LEGSTAR_ANNOTATIONS, true);
        store.setDefault(PreferenceConstants.JAXB_PACKAGE_NAME_PREFIX, "com.legstar.test.coxb");
        store.setDefault(PreferenceConstants.DEFAULT_JAXB_TYPE_CLASSES_SUFFIX, "");
