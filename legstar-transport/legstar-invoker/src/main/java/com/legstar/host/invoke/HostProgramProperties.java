...
public class HostProgramProperties extends HostProgram {
     ...
     */
    public HostProgramProperties(final String fileName)
        ...
        try {
            ...
            String strLength = props
                    .getProperty(Constants.CICS_LENGTH_KEY, "0");
            setMaxDataLength(Integer.parseInt(strLength));
            String strDataLength = props.getProperty(
                    Constants.CICS_DATALEN_KEY, "0");
            setDataLength(Integer.parseInt(strDataLength));
            setSysID(props.getProperty(Constants.CICS_SYSID_KEY));
            String strSyncOnReturn = props
                    .getProperty(Constants.CICS_SYNCONRET_KEY);
             ...
             * list of output containers. Each container has a name and a max
             * size (host bytes).
             */
    ...
    /**
     * Create a map with container names and associated max size from entries in
     * a property file. List of items are expected to be stored as a set of
     * properties suffixed with _n where n in the item rank.
     * 
     ...
     */
    private void loadContainer(final Properties props,
            final List < HostContainer > containers, final String nameKey,
            final String lengthKey) throws HostProgramException {
        int i = 1;
     ...
     */
    public Properties load(final String propFileName) throws IOException {
         ...
         * class will live in a different jar file than the calling application.
         */
