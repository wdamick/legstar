...
public class ObjectFactory {
    ...
    private final static QName _Dfhcommarea_QNAME = new QName("http://legstar.com/test/coxb/vararcom", "Dfhcommarea");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://legstar.com/test/coxb/vararcom", name = "Dfhcommarea")
