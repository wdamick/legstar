...
public class ObjectFactory {
    ...
    private final static QName _BinnatusHostHeader_QNAME = new QName("http://cixs.test.legstar.com/binnatus", "BinnatusHostHeader");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cixs.test.legstar.com/binnatus", name = "BinnatusHostHeader")
    public JAXBElement<BinnatusHostHeader> createBinnatusHostHeader(BinnatusHostHeader value) {
        return new JAXBElement<BinnatusHostHeader>(_BinnatusHostHeader_QNAME, BinnatusHostHeader.class, null, value);
    }
