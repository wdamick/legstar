...
import com.legstar.test.coxb.binnatus.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program BINNATUS.
 * <p/>
 * This host program maps to operation binnatus.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class BinnatusProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for binnatus. */
    private static final String  OPERATION_NAME = "binnatus";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public BinnatusProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new BinnatusHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the BINNATUS host program.
     * <p/>
