 ...
 * 
 */
public class HttpClientLsfileae102ITCase extends AbstractAdapterHttpClientTester {
    ...
    public static final String SOAP_REQUEST = "<?xml version=\"1.0\" ?>"
            ...
            + "<Dfhcommarea>" + "<ComNumber>102</ComNumber>" + "</Dfhcommarea>"
    ...
    public static final String SOAP_REPLY = "<?xml version=\"1.0\" ?>"
            ...
            + "<Dfhcommarea>" + "<ComNumber>102</ComNumber>" + "<ComPersonal>"
            + "<ComName>J. T. CZAYKOWSKI</ComName>"
            + "<ComAddress>WARWICK, ENGLAND</ComAddress>"
            + "<ComPhone>98356183</ComPhone>" + "</ComPersonal>"
            + "<ComDate>26 11 81</ComDate>" + "<ComAmount>$1111.11</ComAmount>"
     ...
     * Construct the test.
     */
    public HttpClientLsfileae102ITCase() {
