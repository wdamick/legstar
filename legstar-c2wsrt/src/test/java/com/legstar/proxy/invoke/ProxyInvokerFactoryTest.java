...
public class ProxyInvokerFactoryTest extends TestCase {
    ...
    /**
     * Test that proxy invoker can be created and if not, we get a friendly
     * error.
     */
    public void testCreateProxyInvoker() {
        try {
             ...
             */
            ProxyInvokerFactory
                    .createProxyInvoker(new HashMap < String, String >());
            fail();
        ...
        try {
            Map < String, String > config = new HashMap < String, String >();
            config.put("proxyInvokerClassName",
        ...
        try {
            Map < String, String > config = CultureinfoJaxwsCases
                    .getDirectConfig();
            IProxyInvoker proxyInvoker = ProxyInvokerFactory
                    .createProxyInvoker(config);
            assertEquals(
