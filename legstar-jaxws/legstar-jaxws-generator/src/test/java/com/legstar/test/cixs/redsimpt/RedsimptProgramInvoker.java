...
import com.legstar.test.coxb.redsimpt.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program REDSIMPT.
 * <p/>
 * This host program maps to operation redsimpt.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class RedsimptProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for redsimpt. */
    private static final String  OPERATION_NAME = "redsimpt";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public RedsimptProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new RedsimptHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the REDSIMPT host program.
     * <p/>
