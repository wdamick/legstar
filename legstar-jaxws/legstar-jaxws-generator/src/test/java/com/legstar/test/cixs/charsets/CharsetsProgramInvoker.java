...
import com.legstar.test.coxb.charsets.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program CHARSETS.
 * <p/>
 * This host program maps to operation charsets.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class CharsetsProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for charsets. */
    private static final String  OPERATION_NAME = "charsets";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public CharsetsProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new CharsetsHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the CHARSETS host program.
     * <p/>
