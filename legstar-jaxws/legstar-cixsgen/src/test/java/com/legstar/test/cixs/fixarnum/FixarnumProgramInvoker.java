...
import com.legstar.test.coxb.fixarnum.bind.DfhcommareaTransformers;

/**
 * Implements an invoker for program FIXARNUM.
 * <p/>
 * This host program maps to operation fixarnum.
 * 
 * This class was generated by LegStar Mainframe Web Service adapter generator.
 *
 */
public class FixarnumProgramInvoker extends AbstractProgramInvoker {

    /** Host transformers for Dfhcommarea java data object. */
    private DfhcommareaTransformers mDfhcommareaTransformers;

    /** Operation name for fixarnum. */
    private static final String  OPERATION_NAME = "fixarnum";

    /**
     * Operation invoker constructor.
     * @param configFileName invoker configuration file name
     */
    public FixarnumProgramInvoker(final String configFileName) {
        super(configFileName, OPERATION_NAME, new FixarnumHostProgram());
        mDfhcommareaTransformers = new DfhcommareaTransformers();
    }

    /**
     * Invoke the FIXARNUM host program.
     * <p/>
