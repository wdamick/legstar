...
public class AntBuildCixs2JaxwsModelTest extends AbstractTestTemplate {
    ...
    public void testCixs2JaxwsBuild() throws Exception {
        ...
        antModel.setWebServiceTargetParameters(Samples
        ...
        assertTrue(resStr.replace('\\', '/').contains(
                "<pathelement location=\"target/src/gen/target/classes\"/>"));
        assertTrue(resStr.contains("<taskdef name=\"cixs2jaxwsgen\""));
        assertTrue(resStr
                .contains("classname=\"com.legstar.cixs.jaxws.gen.Cixs2JaxwsGenerator\""));
        ...
        assertTrue(resStr.replace('\\', '/').contains(
                "targetCobolDir=\"target/src/gen/cobol\""));
        assertTrue(resStr.replace('\\', '/').contains(
                "jaxbBinDir=\"target/src/gen/target/classes\""));
        assertTrue(resStr.replace('\\', '/').contains(
                "coxbBinDir=\"target/src/gen/target/classes\""));
        assertTrue(resStr.replace('\\', '/').contains(
                "custBinDir=\"target/src/gen/target/classes\""));
        ...
        assertTrue(resStr
                .contains("jaxbPackageName=\"com.legstar.test.coxb.cultureinfo\""));
        ...
        assertTrue(resStr
                .contains("http://localhost:8080/legstar-test-cultureinfo/getinfo?wsdl"));
        assertTrue(resStr
                .contains("wsdlTargetNamespace=\"http://cultureinfo.cases.test.xsdc.legstar.com/\""));
        assertTrue(resStr
                .contains("wsdlServiceName=\"CultureInfoImplService\""));
        ...
        assertTrue(resStr
                .contains("path=\"/c2ws-cultureinfo/cultureinfoProxy\""));
